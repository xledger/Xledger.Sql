...
namespace Xledger.Sql.ImmutableDom {
    public class BinaryLiteral : Literal, IEquatable<BinaryLiteral> {
        ...
        public static BinaryLiteral FromMutable(ScriptDom.BinaryLiteral fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.BinaryLiteral)) { throw new NotImplementedException("Unexpected subtype of BinaryLiteral not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
