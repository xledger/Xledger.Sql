...
namespace Xledger.Sql.ImmutableDom {
    public class DropEndpointStatement : DropUnownedObjectStatement, IEquatable<DropEndpointStatement> {
        ...
        public override int CompareTo(TSqlFragment that) {
            ...
            var othr = (DropEndpointStatement)that;
        ...
        public static bool operator < (DropEndpointStatement left, DropEndpointStatement right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(DropEndpointStatement left, DropEndpointStatement right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (DropEndpointStatement left, DropEndpointStatement right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(DropEndpointStatement left, DropEndpointStatement right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static DropEndpointStatement FromMutable(ScriptDom.DropEndpointStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.DropEndpointStatement)) { throw new NotImplementedException("Unexpected subtype of DropEndpointStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
