...
namespace Xledger.Sql.ImmutableDom {
    public class SystemVersioningTableOption : TableOption, IEquatable<SystemVersioningTableOption> {
        ...
        public static SystemVersioningTableOption FromMutable(ScriptDom.SystemVersioningTableOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.SystemVersioningTableOption)) { throw new NotImplementedException("Unexpected subtype of SystemVersioningTableOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new SystemVersioningTableOption(
                ...
                historyTable: ImmutableDom.SchemaObjectName.FromMutable(fragment.HistoryTable),
                retentionPeriod: ImmutableDom.RetentionPeriodDefinition.FromMutable(fragment.RetentionPeriod),
