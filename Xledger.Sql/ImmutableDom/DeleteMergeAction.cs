...
namespace Xledger.Sql.ImmutableDom {
    public class DeleteMergeAction : MergeAction, IEquatable<DeleteMergeAction> {
        ...
        public static DeleteMergeAction FromMutable(ScriptDom.DeleteMergeAction fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.DeleteMergeAction)) { throw new NotImplementedException("Unexpected subtype of DeleteMergeAction not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
