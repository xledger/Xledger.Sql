...
namespace Xledger.Sql.ImmutableDom {
    public class CreateOrAlterFunctionStatement : FunctionStatementBody, IEquatable<CreateOrAlterFunctionStatement> {
        ...
        public static bool operator < (CreateOrAlterFunctionStatement left, CreateOrAlterFunctionStatement right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(CreateOrAlterFunctionStatement left, CreateOrAlterFunctionStatement right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (CreateOrAlterFunctionStatement left, CreateOrAlterFunctionStatement right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(CreateOrAlterFunctionStatement left, CreateOrAlterFunctionStatement right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static CreateOrAlterFunctionStatement FromMutable(ScriptDom.CreateOrAlterFunctionStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.CreateOrAlterFunctionStatement)) { throw new NotImplementedException("Unexpected subtype of CreateOrAlterFunctionStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
