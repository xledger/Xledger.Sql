...
namespace Xledger.Sql.ImmutableDom {
    public class WriteTextStatement : TextModificationStatement, IEquatable<WriteTextStatement> {
        ...
        public static WriteTextStatement FromMutable(ScriptDom.WriteTextStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.WriteTextStatement)) { throw new NotImplementedException("Unexpected subtype of WriteTextStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
