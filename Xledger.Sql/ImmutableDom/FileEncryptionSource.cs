...
namespace Xledger.Sql.ImmutableDom {
    public class FileEncryptionSource : EncryptionSource, IEquatable<FileEncryptionSource> {
        ...
        public static FileEncryptionSource FromMutable(ScriptDom.FileEncryptionSource fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.FileEncryptionSource)) { throw new NotImplementedException("Unexpected subtype of FileEncryptionSource not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
