...
namespace Xledger.Sql.ImmutableDom {
    public class CreateExternalFileFormatStatement : ExternalFileFormatStatement, IEquatable<CreateExternalFileFormatStatement> {
        ...
        public static CreateExternalFileFormatStatement FromMutable(ScriptDom.CreateExternalFileFormatStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.CreateExternalFileFormatStatement)) { throw new NotImplementedException("Unexpected subtype of CreateExternalFileFormatStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
