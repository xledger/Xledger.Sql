...
namespace Xledger.Sql.ImmutableDom {
    public class TablePartitionOption : TableOption, IEquatable<TablePartitionOption> {
        ...
        public static TablePartitionOption FromMutable(ScriptDom.TablePartitionOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.TablePartitionOption)) { throw new NotImplementedException("Unexpected subtype of TablePartitionOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new TablePartitionOption(
                partitionColumn: ImmutableDom.Identifier.FromMutable(fragment.PartitionColumn),
                partitionOptionSpecs: ImmutableDom.TablePartitionOptionSpecifications.FromMutable(fragment.PartitionOptionSpecs),
