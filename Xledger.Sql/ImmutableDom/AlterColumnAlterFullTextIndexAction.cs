...
namespace Xledger.Sql.ImmutableDom {
    public class AlterColumnAlterFullTextIndexAction : AlterFullTextIndexAction, IEquatable<AlterColumnAlterFullTextIndexAction> {
        ...
        public static AlterColumnAlterFullTextIndexAction FromMutable(ScriptDom.AlterColumnAlterFullTextIndexAction fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.AlterColumnAlterFullTextIndexAction)) { throw new NotImplementedException("Unexpected subtype of AlterColumnAlterFullTextIndexAction not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new AlterColumnAlterFullTextIndexAction(
                column: ImmutableDom.FullTextIndexColumn.FromMutable(fragment.Column),
