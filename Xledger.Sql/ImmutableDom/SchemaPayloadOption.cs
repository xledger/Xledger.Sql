...
namespace Xledger.Sql.ImmutableDom {
    public class SchemaPayloadOption : PayloadOption, IEquatable<SchemaPayloadOption> {
        ...
        public static SchemaPayloadOption FromMutable(ScriptDom.SchemaPayloadOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.SchemaPayloadOption)) { throw new NotImplementedException("Unexpected subtype of SchemaPayloadOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
