...
namespace Xledger.Sql.ImmutableDom {
    public class OnOffSessionOption : SessionOption, IEquatable<OnOffSessionOption> {
        ...
        public static OnOffSessionOption FromMutable(ScriptDom.OnOffSessionOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.OnOffSessionOption)) { throw new NotImplementedException("Unexpected subtype of OnOffSessionOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
