...
namespace Xledger.Sql.ImmutableDom {
    public class UpdateCall : BooleanExpression, IEquatable<UpdateCall> {
        ...
        public static UpdateCall FromMutable(ScriptDom.UpdateCall fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.UpdateCall)) { throw new NotImplementedException("Unexpected subtype of UpdateCall not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
