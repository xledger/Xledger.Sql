...
namespace Xledger.Sql.ImmutableDom {
    public class ParseCall : PrimaryExpression, IEquatable<ParseCall> {
        ...
        public override int CompareTo(TSqlFragment that) {
            ...
            compare = StructuralComparisons.StructuralComparer.Compare(this.stringValue, othr.stringValue);
            if (compare != 0) { return compare; }
            compare = StructuralComparisons.StructuralComparer.Compare(this.dataType, othr.dataType);
            if (compare != 0) { return compare; }
            compare = StructuralComparisons.StructuralComparer.Compare(this.culture, othr.culture);
            if (compare != 0) { return compare; }
        ...
        public static ParseCall FromMutable(ScriptDom.ParseCall fragment) {
            return (ParseCall)TSqlFragment.FromMutable(fragment);
        }
