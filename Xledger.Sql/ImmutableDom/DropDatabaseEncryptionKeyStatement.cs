...
namespace Xledger.Sql.ImmutableDom {
    public class DropDatabaseEncryptionKeyStatement : TSqlStatement, IEquatable<DropDatabaseEncryptionKeyStatement> {
        ...
        public static DropDatabaseEncryptionKeyStatement FromMutable(ScriptDom.DropDatabaseEncryptionKeyStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.DropDatabaseEncryptionKeyStatement)) { throw new NotImplementedException("Unexpected subtype of DropDatabaseEncryptionKeyStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
