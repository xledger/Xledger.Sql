...
namespace Xledger.Sql.ImmutableDom {
    public class DropWorkloadGroupStatement : DropUnownedObjectStatement, IEquatable<DropWorkloadGroupStatement> {
        ...
        public override int CompareTo(TSqlFragment that) {
            ...
            var othr = (DropWorkloadGroupStatement)that;
        ...
        public static bool operator < (DropWorkloadGroupStatement left, DropWorkloadGroupStatement right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(DropWorkloadGroupStatement left, DropWorkloadGroupStatement right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (DropWorkloadGroupStatement left, DropWorkloadGroupStatement right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(DropWorkloadGroupStatement left, DropWorkloadGroupStatement right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static DropWorkloadGroupStatement FromMutable(ScriptDom.DropWorkloadGroupStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.DropWorkloadGroupStatement)) { throw new NotImplementedException("Unexpected subtype of DropWorkloadGroupStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
