...
namespace Xledger.Sql.ImmutableDom {
    public class DeclareTableVariableStatement : TSqlStatement, IEquatable<DeclareTableVariableStatement> {
        ...
        public static DeclareTableVariableStatement FromMutable(ScriptDom.DeclareTableVariableStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.DeclareTableVariableStatement)) { throw new NotImplementedException("Unexpected subtype of DeclareTableVariableStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new DeclareTableVariableStatement(
                body: ImmutableDom.DeclareTableVariableBody.FromMutable(fragment.Body)
            );
        }
