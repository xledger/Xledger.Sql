...
namespace Xledger.Sql.ImmutableDom {
    public class AddSignatureStatement : SignatureStatementBase, IEquatable<AddSignatureStatement> {
        ...
        public static AddSignatureStatement FromMutable(ScriptDom.AddSignatureStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.AddSignatureStatement)) { throw new NotImplementedException("Unexpected subtype of AddSignatureStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
