...
namespace Xledger.Sql.ImmutableDom {
    public class CreatePartitionFunctionStatement : TSqlStatement, IEquatable<CreatePartitionFunctionStatement> {
        ...
        public static CreatePartitionFunctionStatement FromMutable(ScriptDom.CreatePartitionFunctionStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.CreatePartitionFunctionStatement)) { throw new NotImplementedException("Unexpected subtype of CreatePartitionFunctionStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
