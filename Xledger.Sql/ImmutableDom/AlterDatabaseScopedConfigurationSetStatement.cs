...
namespace Xledger.Sql.ImmutableDom {
    public class AlterDatabaseScopedConfigurationSetStatement : AlterDatabaseScopedConfigurationStatement, IEquatable<AlterDatabaseScopedConfigurationSetStatement> {
        ...
        public static AlterDatabaseScopedConfigurationSetStatement FromMutable(ScriptDom.AlterDatabaseScopedConfigurationSetStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.AlterDatabaseScopedConfigurationSetStatement)) { throw new NotImplementedException("Unexpected subtype of AlterDatabaseScopedConfigurationSetStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new AlterDatabaseScopedConfigurationSetStatement(
                option: ImmutableDom.DatabaseConfigurationSetOption.FromMutable(fragment.Option),
