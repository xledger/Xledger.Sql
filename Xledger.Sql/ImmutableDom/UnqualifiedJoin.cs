...
namespace Xledger.Sql.ImmutableDom {
    public class UnqualifiedJoin : JoinTableReference, IEquatable<UnqualifiedJoin> {
        ...
        public override int CompareTo(TSqlFragment that) {
            ...
            compare = StructuralComparisons.StructuralComparer.Compare(this.unqualifiedJoinType, othr.unqualifiedJoinType);
        ...
        public static UnqualifiedJoin FromMutable(ScriptDom.UnqualifiedJoin fragment) {
            return (UnqualifiedJoin)TSqlFragment.FromMutable(fragment);
        }
