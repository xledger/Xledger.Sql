...
namespace Xledger.Sql.ImmutableDom {
    public class GraphConnectionBetweenNodes : TSqlFragment, IEquatable<GraphConnectionBetweenNodes> {
        ...
        public static GraphConnectionBetweenNodes FromMutable(ScriptDom.GraphConnectionBetweenNodes fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.GraphConnectionBetweenNodes)) { throw new NotImplementedException("Unexpected subtype of GraphConnectionBetweenNodes not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new GraphConnectionBetweenNodes(
                fromNode: ImmutableDom.SchemaObjectName.FromMutable(fragment.FromNode),
                toNode: ImmutableDom.SchemaObjectName.FromMutable(fragment.ToNode)
            );
        }
