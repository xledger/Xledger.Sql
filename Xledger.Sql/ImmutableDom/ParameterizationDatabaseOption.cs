...
namespace Xledger.Sql.ImmutableDom {
    public class ParameterizationDatabaseOption : DatabaseOption, IEquatable<ParameterizationDatabaseOption> {
        ...
        public new ScriptDom.ParameterizationDatabaseOption ToMutableConcrete() {
        ...
        public static ParameterizationDatabaseOption FromMutable(ScriptDom.ParameterizationDatabaseOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.ParameterizationDatabaseOption)) { throw new NotImplementedException("Unexpected subtype of ParameterizationDatabaseOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
