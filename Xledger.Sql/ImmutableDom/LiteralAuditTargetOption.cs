...
namespace Xledger.Sql.ImmutableDom {
    public class LiteralAuditTargetOption : AuditTargetOption, IEquatable<LiteralAuditTargetOption> {
        ...
        public static LiteralAuditTargetOption FromMutable(ScriptDom.LiteralAuditTargetOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.LiteralAuditTargetOption)) { throw new NotImplementedException("Unexpected subtype of LiteralAuditTargetOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
