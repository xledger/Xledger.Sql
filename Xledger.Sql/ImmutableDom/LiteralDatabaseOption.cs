...
namespace Xledger.Sql.ImmutableDom {
    public class LiteralDatabaseOption : DatabaseOption, IEquatable<LiteralDatabaseOption> {
        ...
        public new ScriptDom.LiteralDatabaseOption ToMutableConcrete() {
        ...
        public static LiteralDatabaseOption FromMutable(ScriptDom.LiteralDatabaseOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.LiteralDatabaseOption)) { throw new NotImplementedException("Unexpected subtype of LiteralDatabaseOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
