...
namespace Xledger.Sql.ImmutableDom {
    public abstract class SecurityStatementBody80 : TSqlStatement {
        ...
        public static SecurityStatementBody80 FromMutable(ScriptDom.SecurityStatementBody80 fragment) {
            return (SecurityStatementBody80)TSqlFragment.FromMutable(fragment);
        }
