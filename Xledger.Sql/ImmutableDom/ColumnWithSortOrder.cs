...
namespace Xledger.Sql.ImmutableDom {
    public class ColumnWithSortOrder : TSqlFragment, IEquatable<ColumnWithSortOrder> {
        ...
        public static ColumnWithSortOrder FromMutable(ScriptDom.ColumnWithSortOrder fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.ColumnWithSortOrder)) { throw new NotImplementedException("Unexpected subtype of ColumnWithSortOrder not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
