...
namespace Xledger.Sql.ImmutableDom {
    public class ExternalCreateLoginSource : CreateLoginSource, IEquatable<ExternalCreateLoginSource> {
        ...
        public static bool operator < (ExternalCreateLoginSource left, ExternalCreateLoginSource right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(ExternalCreateLoginSource left, ExternalCreateLoginSource right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (ExternalCreateLoginSource left, ExternalCreateLoginSource right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(ExternalCreateLoginSource left, ExternalCreateLoginSource right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static ExternalCreateLoginSource FromMutable(ScriptDom.ExternalCreateLoginSource fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.ExternalCreateLoginSource)) { throw new NotImplementedException("Unexpected subtype of ExternalCreateLoginSource not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
