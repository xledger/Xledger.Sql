...
namespace Xledger.Sql.ImmutableDom {
    public class DropCredentialStatement : DropUnownedObjectStatement, IEquatable<DropCredentialStatement> {
        ...
        public static DropCredentialStatement FromMutable(ScriptDom.DropCredentialStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.DropCredentialStatement)) { throw new NotImplementedException("Unexpected subtype of DropCredentialStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
