...
namespace Xledger.Sql.ImmutableDom {
    public class ClassifierWlmLabelOption : WorkloadClassifierOption, IEquatable<ClassifierWlmLabelOption> {
        ...
        public override int CompareTo(TSqlFragment that) {
            ...
            compare = Comparer.DefaultInvariant.Compare(this.wlmLabel, othr.wlmLabel);
        ...
        public static bool operator < (ClassifierWlmLabelOption left, ClassifierWlmLabelOption right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(ClassifierWlmLabelOption left, ClassifierWlmLabelOption right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (ClassifierWlmLabelOption left, ClassifierWlmLabelOption right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(ClassifierWlmLabelOption left, ClassifierWlmLabelOption right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static ClassifierWlmLabelOption FromMutable(ScriptDom.ClassifierWlmLabelOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.ClassifierWlmLabelOption)) { throw new NotImplementedException("Unexpected subtype of ClassifierWlmLabelOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new ClassifierWlmLabelOption(
                wlmLabel: ImmutableDom.StringLiteral.FromMutable(fragment.WlmLabel),
