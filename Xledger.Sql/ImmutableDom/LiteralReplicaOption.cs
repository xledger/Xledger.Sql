...
namespace Xledger.Sql.ImmutableDom {
    public class LiteralReplicaOption : AvailabilityReplicaOption, IEquatable<LiteralReplicaOption> {
        ...
        public static LiteralReplicaOption FromMutable(ScriptDom.LiteralReplicaOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.LiteralReplicaOption)) { throw new NotImplementedException("Unexpected subtype of LiteralReplicaOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
