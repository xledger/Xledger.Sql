...
namespace Xledger.Sql.ImmutableDom {
    public class LiteralEndpointProtocolOption : EndpointProtocolOption, IEquatable<LiteralEndpointProtocolOption> {
        ...
        public static LiteralEndpointProtocolOption FromMutable(ScriptDom.LiteralEndpointProtocolOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.LiteralEndpointProtocolOption)) { throw new NotImplementedException("Unexpected subtype of LiteralEndpointProtocolOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
