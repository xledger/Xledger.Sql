...
namespace Xledger.Sql.ImmutableDom {
    public class SimpleAlterFullTextIndexAction : AlterFullTextIndexAction, IEquatable<SimpleAlterFullTextIndexAction> {
        ...
        public static SimpleAlterFullTextIndexAction FromMutable(ScriptDom.SimpleAlterFullTextIndexAction fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.SimpleAlterFullTextIndexAction)) { throw new NotImplementedException("Unexpected subtype of SimpleAlterFullTextIndexAction not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
