...
namespace Xledger.Sql.ImmutableDom {
    public class OnOffAtomicBlockOption : AtomicBlockOption, IEquatable<OnOffAtomicBlockOption> {
        ...
        public static bool operator < (OnOffAtomicBlockOption left, OnOffAtomicBlockOption right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(OnOffAtomicBlockOption left, OnOffAtomicBlockOption right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (OnOffAtomicBlockOption left, OnOffAtomicBlockOption right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(OnOffAtomicBlockOption left, OnOffAtomicBlockOption right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static OnOffAtomicBlockOption FromMutable(ScriptDom.OnOffAtomicBlockOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.OnOffAtomicBlockOption)) { throw new NotImplementedException("Unexpected subtype of OnOffAtomicBlockOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
