...
namespace Xledger.Sql.ImmutableDom {
    public class ExternalStreamLiteralOrIdentifierOption : ExternalStreamOption, IEquatable<ExternalStreamLiteralOrIdentifierOption> {
        ...
        public static ExternalStreamLiteralOrIdentifierOption FromMutable(ScriptDom.ExternalStreamLiteralOrIdentifierOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.ExternalStreamLiteralOrIdentifierOption)) { throw new NotImplementedException("Unexpected subtype of ExternalStreamLiteralOrIdentifierOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
