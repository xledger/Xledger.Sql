...
namespace Xledger.Sql.ImmutableDom {
    public class AlterTableAlterIndexStatement : AlterTableStatement, IEquatable<AlterTableAlterIndexStatement> {
        ...
        public static AlterTableAlterIndexStatement FromMutable(ScriptDom.AlterTableAlterIndexStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.AlterTableAlterIndexStatement)) { throw new NotImplementedException("Unexpected subtype of AlterTableAlterIndexStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
