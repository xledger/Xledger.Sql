...
namespace Xledger.Sql.ImmutableDom {
    public class WindowDelimiter : TSqlFragment, IEquatable<WindowDelimiter> {
        ...
        public static WindowDelimiter FromMutable(ScriptDom.WindowDelimiter fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.WindowDelimiter)) { throw new NotImplementedException("Unexpected subtype of WindowDelimiter not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new WindowDelimiter(
                windowDelimiterType: fragment.WindowDelimiterType,
                offsetValue: ImmutableDom.ScalarExpression.FromMutable(fragment.OffsetValue)
            );
        }
