...
namespace Xledger.Sql.ImmutableDom {
    public class SearchedWhenClause : WhenClause, IEquatable<SearchedWhenClause> {
        ...
        public static SearchedWhenClause FromMutable(ScriptDom.SearchedWhenClause fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.SearchedWhenClause)) { throw new NotImplementedException("Unexpected subtype of SearchedWhenClause not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new SearchedWhenClause(
                whenExpression: ImmutableDom.BooleanExpression.FromMutable(fragment.WhenExpression),
