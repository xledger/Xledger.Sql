...
namespace Xledger.Sql.ImmutableDom {
    public class ClassifierEndTimeOption : WorkloadClassifierOption, IEquatable<ClassifierEndTimeOption> {
        ...
        public static ClassifierEndTimeOption FromMutable(ScriptDom.ClassifierEndTimeOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.ClassifierEndTimeOption)) { throw new NotImplementedException("Unexpected subtype of ClassifierEndTimeOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
