...
namespace Xledger.Sql.ImmutableDom {
    public class FullTextIndexColumn : TSqlFragment, IEquatable<FullTextIndexColumn> {
        ...
        public static FullTextIndexColumn FromMutable(ScriptDom.FullTextIndexColumn fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.FullTextIndexColumn)) { throw new NotImplementedException("Unexpected subtype of FullTextIndexColumn not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new FullTextIndexColumn(
                name: ImmutableDom.Identifier.FromMutable(fragment.Name),
                typeColumn: ImmutableDom.Identifier.FromMutable(fragment.TypeColumn),
