...
namespace Xledger.Sql.ImmutableDom {
    public class CreateMessageTypeStatement : MessageTypeStatementBase, IEquatable<CreateMessageTypeStatement> {
        ...
        public static bool operator < (CreateMessageTypeStatement left, CreateMessageTypeStatement right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(CreateMessageTypeStatement left, CreateMessageTypeStatement right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (CreateMessageTypeStatement left, CreateMessageTypeStatement right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(CreateMessageTypeStatement left, CreateMessageTypeStatement right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static CreateMessageTypeStatement FromMutable(ScriptDom.CreateMessageTypeStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.CreateMessageTypeStatement)) { throw new NotImplementedException("Unexpected subtype of CreateMessageTypeStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
