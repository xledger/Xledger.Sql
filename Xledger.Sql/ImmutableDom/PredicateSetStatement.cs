...
namespace Xledger.Sql.ImmutableDom {
    public class PredicateSetStatement : SetOnOffStatement, IEquatable<PredicateSetStatement> {
        ...
        public static bool operator < (PredicateSetStatement left, PredicateSetStatement right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(PredicateSetStatement left, PredicateSetStatement right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (PredicateSetStatement left, PredicateSetStatement right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(PredicateSetStatement left, PredicateSetStatement right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static PredicateSetStatement FromMutable(ScriptDom.PredicateSetStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.PredicateSetStatement)) { throw new NotImplementedException("Unexpected subtype of PredicateSetStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
