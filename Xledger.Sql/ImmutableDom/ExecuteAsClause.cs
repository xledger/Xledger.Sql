...
namespace Xledger.Sql.ImmutableDom {
    public class ExecuteAsClause : TSqlFragment, IEquatable<ExecuteAsClause> {
        ...
        public static ExecuteAsClause FromMutable(ScriptDom.ExecuteAsClause fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.ExecuteAsClause)) { throw new NotImplementedException("Unexpected subtype of ExecuteAsClause not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
