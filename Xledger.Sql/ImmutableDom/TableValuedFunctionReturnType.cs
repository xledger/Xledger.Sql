...
namespace Xledger.Sql.ImmutableDom {
    public class TableValuedFunctionReturnType : FunctionReturnType, IEquatable<TableValuedFunctionReturnType> {
        ...
        public override int CompareTo(TSqlFragment that) {
            ...
            compare = StructuralComparisons.StructuralComparer.Compare(this.declareTableVariableBody, othr.declareTableVariableBody);
            if (compare != 0) { return compare; }
            return compare;
        } 
    
        public static TableValuedFunctionReturnType FromMutable(ScriptDom.TableValuedFunctionReturnType fragment) {
            return (TableValuedFunctionReturnType)TSqlFragment.FromMutable(fragment);
        }
