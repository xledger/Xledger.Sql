...
namespace Xledger.Sql.ImmutableDom {
    public abstract class TextModificationStatement : TSqlStatement {
        ...
        public static TextModificationStatement FromMutable(ScriptDom.TextModificationStatement fragment) => (TextModificationStatement)TSqlFragment.FromMutable(fragment);
