...
namespace Xledger.Sql.ImmutableDom {
    public class FileStreamDatabaseOption : DatabaseOption, IEquatable<FileStreamDatabaseOption> {
        ...
        public override int CompareTo(TSqlFragment that) {
            ...
            compare = StructuralComparisons.StructuralComparer.Compare(this.nonTransactedAccess, othr.nonTransactedAccess);
            if (compare != 0) { return compare; }
            compare = StructuralComparisons.StructuralComparer.Compare(this.directoryName, othr.directoryName);
            if (compare != 0) { return compare; }
        ...
        public static FileStreamDatabaseOption FromMutable(ScriptDom.FileStreamDatabaseOption fragment) {
            return (FileStreamDatabaseOption)TSqlFragment.FromMutable(fragment);
        }
