...
namespace Xledger.Sql.ImmutableDom {
    public class ApplicationRoleOption : TSqlFragment, IEquatable<ApplicationRoleOption> {
        ...
        public static ApplicationRoleOption FromMutable(ScriptDom.ApplicationRoleOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.ApplicationRoleOption)) { throw new NotImplementedException("Unexpected subtype of ApplicationRoleOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
