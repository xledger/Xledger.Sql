...
namespace Xledger.Sql.ImmutableDom {
    public class TableSampleClause : TSqlFragment, IEquatable<TableSampleClause> {
        ...
        public static TableSampleClause FromMutable(ScriptDom.TableSampleClause fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.TableSampleClause)) { throw new NotImplementedException("Unexpected subtype of TableSampleClause not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new TableSampleClause(
                system: fragment.System,
                sampleNumber: ImmutableDom.ScalarExpression.FromMutable(fragment.SampleNumber),
                tableSampleClauseOption: fragment.TableSampleClauseOption,
                repeatSeed: ImmutableDom.ScalarExpression.FromMutable(fragment.RepeatSeed)
            );
        }
