...
namespace Xledger.Sql.ImmutableDom {
    public class OdbcConvertSpecification : ScalarExpression, IEquatable<OdbcConvertSpecification> {
        ...
        public override int CompareTo(TSqlFragment that) {
            ...
            var othr = (OdbcConvertSpecification)that;
        ...
        public static OdbcConvertSpecification FromMutable(ScriptDom.OdbcConvertSpecification fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.OdbcConvertSpecification)) { throw new NotImplementedException("Unexpected subtype of OdbcConvertSpecification not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
