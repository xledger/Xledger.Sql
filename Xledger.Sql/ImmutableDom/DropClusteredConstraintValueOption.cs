...
namespace Xledger.Sql.ImmutableDom {
    public class DropClusteredConstraintValueOption : DropClusteredConstraintOption, IEquatable<DropClusteredConstraintValueOption> {
        ...
        public static DropClusteredConstraintValueOption FromMutable(ScriptDom.DropClusteredConstraintValueOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.DropClusteredConstraintValueOption)) { throw new NotImplementedException("Unexpected subtype of DropClusteredConstraintValueOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new DropClusteredConstraintValueOption(
                optionValue: ImmutableDom.Literal.FromMutable(fragment.OptionValue),
