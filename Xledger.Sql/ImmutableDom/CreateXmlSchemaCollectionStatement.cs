...
namespace Xledger.Sql.ImmutableDom {
    public class CreateXmlSchemaCollectionStatement : TSqlStatement, IEquatable<CreateXmlSchemaCollectionStatement> {
        ...
        public static CreateXmlSchemaCollectionStatement FromMutable(ScriptDom.CreateXmlSchemaCollectionStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.CreateXmlSchemaCollectionStatement)) { throw new NotImplementedException("Unexpected subtype of CreateXmlSchemaCollectionStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
