...
namespace Xledger.Sql.ImmutableDom {
    public class ColumnReferenceExpression : PrimaryExpression, IEquatable<ColumnReferenceExpression> {
        ...
        public static ColumnReferenceExpression FromMutable(ScriptDom.ColumnReferenceExpression fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.ColumnReferenceExpression)) { throw new NotImplementedException("Unexpected subtype of ColumnReferenceExpression not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
