...
namespace Xledger.Sql.ImmutableDom {
    public class LocationOption : TableOption, IEquatable<LocationOption> {
        ...
        public static LocationOption FromMutable(ScriptDom.LocationOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.LocationOption)) { throw new NotImplementedException("Unexpected subtype of LocationOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new LocationOption(
                locationValue: ImmutableDom.Identifier.FromMutable(fragment.LocationValue),
