...
namespace Xledger.Sql.ImmutableDom {
    public class DropExternalStreamingJobStatement : DropUnownedObjectStatement, IEquatable<DropExternalStreamingJobStatement> {
        ...
        public static DropExternalStreamingJobStatement FromMutable(ScriptDom.DropExternalStreamingJobStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.DropExternalStreamingJobStatement)) { throw new NotImplementedException("Unexpected subtype of DropExternalStreamingJobStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
