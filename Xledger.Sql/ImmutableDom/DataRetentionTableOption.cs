...
namespace Xledger.Sql.ImmutableDom {
    public class DataRetentionTableOption : TableOption, IEquatable<DataRetentionTableOption> {
        ...
        public static DataRetentionTableOption FromMutable(ScriptDom.DataRetentionTableOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.DataRetentionTableOption)) { throw new NotImplementedException("Unexpected subtype of DataRetentionTableOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new DataRetentionTableOption(
                optionState: fragment.OptionState,
                filterColumn: ImmutableDom.Identifier.FromMutable(fragment.FilterColumn),
