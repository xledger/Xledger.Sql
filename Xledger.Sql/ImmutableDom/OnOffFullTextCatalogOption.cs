...
namespace Xledger.Sql.ImmutableDom {
    public class OnOffFullTextCatalogOption : FullTextCatalogOption, IEquatable<OnOffFullTextCatalogOption> {
        ...
        public static OnOffFullTextCatalogOption FromMutable(ScriptDom.OnOffFullTextCatalogOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.OnOffFullTextCatalogOption)) { throw new NotImplementedException("Unexpected subtype of OnOffFullTextCatalogOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
