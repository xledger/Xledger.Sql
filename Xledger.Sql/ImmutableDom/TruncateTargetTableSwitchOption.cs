...
namespace Xledger.Sql.ImmutableDom {
    public class TruncateTargetTableSwitchOption : TableSwitchOption, IEquatable<TruncateTargetTableSwitchOption> {
        ...
        public static TruncateTargetTableSwitchOption FromMutable(ScriptDom.TruncateTargetTableSwitchOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.TruncateTargetTableSwitchOption)) { throw new NotImplementedException("Unexpected subtype of TruncateTargetTableSwitchOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
