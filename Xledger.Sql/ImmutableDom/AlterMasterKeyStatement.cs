...
namespace Xledger.Sql.ImmutableDom {
    public class AlterMasterKeyStatement : MasterKeyStatement, IEquatable<AlterMasterKeyStatement> {
        ...
        public static bool operator < (AlterMasterKeyStatement left, AlterMasterKeyStatement right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(AlterMasterKeyStatement left, AlterMasterKeyStatement right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (AlterMasterKeyStatement left, AlterMasterKeyStatement right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(AlterMasterKeyStatement left, AlterMasterKeyStatement right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static AlterMasterKeyStatement FromMutable(ScriptDom.AlterMasterKeyStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.AlterMasterKeyStatement)) { throw new NotImplementedException("Unexpected subtype of AlterMasterKeyStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
