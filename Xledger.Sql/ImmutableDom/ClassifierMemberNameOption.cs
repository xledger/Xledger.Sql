...
namespace Xledger.Sql.ImmutableDom {
    public class ClassifierMemberNameOption : WorkloadClassifierOption, IEquatable<ClassifierMemberNameOption> {
        ...
        public static ClassifierMemberNameOption FromMutable(ScriptDom.ClassifierMemberNameOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.ClassifierMemberNameOption)) { throw new NotImplementedException("Unexpected subtype of ClassifierMemberNameOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new ClassifierMemberNameOption(
                memberName: ImmutableDom.StringLiteral.FromMutable(fragment.MemberName),
