...
namespace Xledger.Sql.ImmutableDom {
    public class EndConversationStatement : TSqlStatement, IEquatable<EndConversationStatement> {
        ...
        public static EndConversationStatement FromMutable(ScriptDom.EndConversationStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.EndConversationStatement)) { throw new NotImplementedException("Unexpected subtype of EndConversationStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new EndConversationStatement(
                ...
                errorCode: ImmutableDom.ValueExpression.FromMutable(fragment.ErrorCode),
                errorDescription: ImmutableDom.ValueExpression.FromMutable(fragment.ErrorDescription)
            );
        }
