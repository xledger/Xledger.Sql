...
namespace Xledger.Sql.ImmutableDom {
    public class IdentifierDatabaseOption : DatabaseOption, IEquatable<IdentifierDatabaseOption> {
        ...
        public new ScriptDom.IdentifierDatabaseOption ToMutableConcrete() {
        ...
        public static IdentifierDatabaseOption FromMutable(ScriptDom.IdentifierDatabaseOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.IdentifierDatabaseOption)) { throw new NotImplementedException("Unexpected subtype of IdentifierDatabaseOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
