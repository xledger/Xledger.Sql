...
namespace Xledger.Sql.ImmutableDom {
    public class IndexType : TSqlFragment, IEquatable<IndexType> {
        ...
        public static IndexType FromMutable(ScriptDom.IndexType fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.IndexType)) { throw new NotImplementedException("Unexpected subtype of IndexType not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
