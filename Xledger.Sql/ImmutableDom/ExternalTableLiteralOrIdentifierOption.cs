...
namespace Xledger.Sql.ImmutableDom {
    public class ExternalTableLiteralOrIdentifierOption : ExternalTableOption, IEquatable<ExternalTableLiteralOrIdentifierOption> {
        ...
        public static bool operator < (ExternalTableLiteralOrIdentifierOption left, ExternalTableLiteralOrIdentifierOption right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(ExternalTableLiteralOrIdentifierOption left, ExternalTableLiteralOrIdentifierOption right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (ExternalTableLiteralOrIdentifierOption left, ExternalTableLiteralOrIdentifierOption right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(ExternalTableLiteralOrIdentifierOption left, ExternalTableLiteralOrIdentifierOption right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static ExternalTableLiteralOrIdentifierOption FromMutable(ScriptDom.ExternalTableLiteralOrIdentifierOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.ExternalTableLiteralOrIdentifierOption)) { throw new NotImplementedException("Unexpected subtype of ExternalTableLiteralOrIdentifierOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
