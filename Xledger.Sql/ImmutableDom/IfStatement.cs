...
namespace Xledger.Sql.ImmutableDom {
    public class IfStatement : TSqlStatement, IEquatable<IfStatement> {
        ...
        public static IfStatement FromMutable(ScriptDom.IfStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.IfStatement)) { throw new NotImplementedException("Unexpected subtype of IfStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new IfStatement(
                predicate: ImmutableDom.BooleanExpression.FromMutable(fragment.Predicate),
                thenStatement: ImmutableDom.TSqlStatement.FromMutable(fragment.ThenStatement),
                elseStatement: ImmutableDom.TSqlStatement.FromMutable(fragment.ElseStatement)
            );
        }
