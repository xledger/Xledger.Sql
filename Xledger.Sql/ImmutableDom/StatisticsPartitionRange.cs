...
namespace Xledger.Sql.ImmutableDom {
    public class StatisticsPartitionRange : TSqlFragment, IEquatable<StatisticsPartitionRange> {
        ...
        public static StatisticsPartitionRange FromMutable(ScriptDom.StatisticsPartitionRange fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.StatisticsPartitionRange)) { throw new NotImplementedException("Unexpected subtype of StatisticsPartitionRange not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new StatisticsPartitionRange(
                from: ImmutableDom.IntegerLiteral.FromMutable(fragment.From),
                to: ImmutableDom.IntegerLiteral.FromMutable(fragment.To)
            );
        }
