...
namespace Xledger.Sql.ImmutableDom {
    public class CreateAsymmetricKeyStatement : TSqlStatement, IEquatable<CreateAsymmetricKeyStatement> {
        ...
        public static CreateAsymmetricKeyStatement FromMutable(ScriptDom.CreateAsymmetricKeyStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.CreateAsymmetricKeyStatement)) { throw new NotImplementedException("Unexpected subtype of CreateAsymmetricKeyStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new CreateAsymmetricKeyStatement(
                name: ImmutableDom.Identifier.FromMutable(fragment.Name),
                keySource: ImmutableDom.EncryptionSource.FromMutable(fragment.KeySource),
