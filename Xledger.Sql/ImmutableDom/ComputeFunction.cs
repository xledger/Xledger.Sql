...
namespace Xledger.Sql.ImmutableDom {
    public class ComputeFunction : TSqlFragment, IEquatable<ComputeFunction> {
        ...
        public override int CompareTo(TSqlFragment that) {
            ...
            compare = StructuralComparisons.StructuralComparer.Compare(this.computeFunctionType, othr.computeFunctionType);
        ...
        public static ComputeFunction FromMutable(ScriptDom.ComputeFunction fragment) {
            return (ComputeFunction)TSqlFragment.FromMutable(fragment);
        }
