...
namespace Xledger.Sql.ImmutableDom {
    public class ComputeFunction : TSqlFragment, IEquatable<ComputeFunction> {
        ...
        public static ComputeFunction FromMutable(ScriptDom.ComputeFunction fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.ComputeFunction)) { throw new NotImplementedException("Unexpected subtype of ComputeFunction not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
