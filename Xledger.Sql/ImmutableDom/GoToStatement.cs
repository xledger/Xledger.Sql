...
namespace Xledger.Sql.ImmutableDom {
    public class GoToStatement : TSqlStatement, IEquatable<GoToStatement> {
        ...
        public static GoToStatement FromMutable(ScriptDom.GoToStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.GoToStatement)) { throw new NotImplementedException("Unexpected subtype of GoToStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new GoToStatement(
                labelName: ImmutableDom.Identifier.FromMutable(fragment.LabelName)
            );
        }
