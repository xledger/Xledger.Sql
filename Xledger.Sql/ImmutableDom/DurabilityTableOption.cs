...
namespace Xledger.Sql.ImmutableDom {
    public class DurabilityTableOption : TableOption, IEquatable<DurabilityTableOption> {
        ...
        public static DurabilityTableOption FromMutable(ScriptDom.DurabilityTableOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.DurabilityTableOption)) { throw new NotImplementedException("Unexpected subtype of DurabilityTableOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
