...
namespace Xledger.Sql.ImmutableDom {
    public class IdentityValueKeyOption : KeyOption, IEquatable<IdentityValueKeyOption> {
        ...
        public static IdentityValueKeyOption FromMutable(ScriptDom.IdentityValueKeyOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.IdentityValueKeyOption)) { throw new NotImplementedException("Unexpected subtype of IdentityValueKeyOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new IdentityValueKeyOption(
                identityPhrase: ImmutableDom.Literal.FromMutable(fragment.IdentityPhrase),
