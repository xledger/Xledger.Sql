...
namespace Xledger.Sql.ImmutableDom {
    public class RemoteDataArchiveDbServerSetting : RemoteDataArchiveDatabaseSetting, IEquatable<RemoteDataArchiveDbServerSetting> {
        ...
        public static RemoteDataArchiveDbServerSetting FromMutable(ScriptDom.RemoteDataArchiveDbServerSetting fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.RemoteDataArchiveDbServerSetting)) { throw new NotImplementedException("Unexpected subtype of RemoteDataArchiveDbServerSetting not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new RemoteDataArchiveDbServerSetting(
                server: ImmutableDom.StringLiteral.FromMutable(fragment.Server),
