...
namespace Xledger.Sql.ImmutableDom {
    public class AssignmentSetClause : SetClause, IEquatable<AssignmentSetClause> {
        ...
        public static AssignmentSetClause FromMutable(ScriptDom.AssignmentSetClause fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.AssignmentSetClause)) { throw new NotImplementedException("Unexpected subtype of AssignmentSetClause not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new AssignmentSetClause(
                ...
                newValue: ImmutableDom.ScalarExpression.FromMutable(fragment.NewValue),
