...
namespace Xledger.Sql.ImmutableDom {
    public class CloseMasterKeyStatement : TSqlStatement, IEquatable<CloseMasterKeyStatement> {
        ...
        public static bool operator < (CloseMasterKeyStatement left, CloseMasterKeyStatement right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(CloseMasterKeyStatement left, CloseMasterKeyStatement right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (CloseMasterKeyStatement left, CloseMasterKeyStatement right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(CloseMasterKeyStatement left, CloseMasterKeyStatement right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static CloseMasterKeyStatement FromMutable(ScriptDom.CloseMasterKeyStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.CloseMasterKeyStatement)) { throw new NotImplementedException("Unexpected subtype of CloseMasterKeyStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
