...
namespace Xledger.Sql.ImmutableDom {
    public class AuditGuidAuditOption : AuditOption, IEquatable<AuditGuidAuditOption> {
        ...
        public static bool operator < (AuditGuidAuditOption left, AuditGuidAuditOption right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(AuditGuidAuditOption left, AuditGuidAuditOption right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (AuditGuidAuditOption left, AuditGuidAuditOption right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(AuditGuidAuditOption left, AuditGuidAuditOption right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static AuditGuidAuditOption FromMutable(ScriptDom.AuditGuidAuditOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.AuditGuidAuditOption)) { throw new NotImplementedException("Unexpected subtype of AuditGuidAuditOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new AuditGuidAuditOption(
                guid: ImmutableDom.Literal.FromMutable(fragment.Guid),
