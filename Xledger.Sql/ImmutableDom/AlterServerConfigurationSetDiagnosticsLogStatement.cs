...
namespace Xledger.Sql.ImmutableDom {
    public class AlterServerConfigurationSetDiagnosticsLogStatement : TSqlStatement, IEquatable<AlterServerConfigurationSetDiagnosticsLogStatement> {
        ...
        public static bool operator < (AlterServerConfigurationSetDiagnosticsLogStatement left, AlterServerConfigurationSetDiagnosticsLogStatement right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(AlterServerConfigurationSetDiagnosticsLogStatement left, AlterServerConfigurationSetDiagnosticsLogStatement right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (AlterServerConfigurationSetDiagnosticsLogStatement left, AlterServerConfigurationSetDiagnosticsLogStatement right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(AlterServerConfigurationSetDiagnosticsLogStatement left, AlterServerConfigurationSetDiagnosticsLogStatement right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
