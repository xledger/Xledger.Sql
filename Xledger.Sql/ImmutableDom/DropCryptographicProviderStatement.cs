...
namespace Xledger.Sql.ImmutableDom {
    public class DropCryptographicProviderStatement : DropUnownedObjectStatement, IEquatable<DropCryptographicProviderStatement> {
        ...
        public override int CompareTo(TSqlFragment that) {
            ...
            var othr = (DropCryptographicProviderStatement)that;
        ...
        public static bool operator < (DropCryptographicProviderStatement left, DropCryptographicProviderStatement right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(DropCryptographicProviderStatement left, DropCryptographicProviderStatement right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (DropCryptographicProviderStatement left, DropCryptographicProviderStatement right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(DropCryptographicProviderStatement left, DropCryptographicProviderStatement right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static DropCryptographicProviderStatement FromMutable(ScriptDom.DropCryptographicProviderStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.DropCryptographicProviderStatement)) { throw new NotImplementedException("Unexpected subtype of DropCryptographicProviderStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
