...
namespace Xledger.Sql.ImmutableDom {
    public class IndexExpressionOption : IndexOption, IEquatable<IndexExpressionOption> {
        ...
        public static IndexExpressionOption FromMutable(ScriptDom.IndexExpressionOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.IndexExpressionOption)) { throw new NotImplementedException("Unexpected subtype of IndexExpressionOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
