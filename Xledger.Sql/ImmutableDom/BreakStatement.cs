...
namespace Xledger.Sql.ImmutableDom {
    public class BreakStatement : TSqlStatement, IEquatable<BreakStatement> {
        ...
        public static BreakStatement FromMutable(ScriptDom.BreakStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.BreakStatement)) { throw new NotImplementedException("Unexpected subtype of BreakStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
