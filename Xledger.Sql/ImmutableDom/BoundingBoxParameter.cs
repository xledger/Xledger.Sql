...
namespace Xledger.Sql.ImmutableDom {
    public class BoundingBoxParameter : TSqlFragment, IEquatable<BoundingBoxParameter> {
        ...
        public static BoundingBoxParameter FromMutable(ScriptDom.BoundingBoxParameter fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.BoundingBoxParameter)) { throw new NotImplementedException("Unexpected subtype of BoundingBoxParameter not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
