...
namespace Xledger.Sql.ImmutableDom {
    public class ServiceContract : TSqlFragment, IEquatable<ServiceContract> {
        ...
        public static ServiceContract FromMutable(ScriptDom.ServiceContract fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.ServiceContract)) { throw new NotImplementedException("Unexpected subtype of ServiceContract not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
