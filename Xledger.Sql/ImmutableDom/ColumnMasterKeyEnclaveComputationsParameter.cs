...
namespace Xledger.Sql.ImmutableDom {
    public class ColumnMasterKeyEnclaveComputationsParameter : ColumnMasterKeyParameter, IEquatable<ColumnMasterKeyEnclaveComputationsParameter> {
        ...
        public static ColumnMasterKeyEnclaveComputationsParameter FromMutable(ScriptDom.ColumnMasterKeyEnclaveComputationsParameter fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.ColumnMasterKeyEnclaveComputationsParameter)) { throw new NotImplementedException("Unexpected subtype of ColumnMasterKeyEnclaveComputationsParameter not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new ColumnMasterKeyEnclaveComputationsParameter(
                signature: ImmutableDom.BinaryLiteral.FromMutable(fragment.Signature),
