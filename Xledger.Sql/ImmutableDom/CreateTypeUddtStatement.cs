...
namespace Xledger.Sql.ImmutableDom {
    public class CreateTypeUddtStatement : CreateTypeStatement, IEquatable<CreateTypeUddtStatement> {
        ...
        public static CreateTypeUddtStatement FromMutable(ScriptDom.CreateTypeUddtStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.CreateTypeUddtStatement)) { throw new NotImplementedException("Unexpected subtype of CreateTypeUddtStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
