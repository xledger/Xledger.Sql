...
namespace Xledger.Sql.ImmutableDom {
    public class FileStreamOnDropIndexOption : IndexOption, IEquatable<FileStreamOnDropIndexOption> {
        ...
        public static FileStreamOnDropIndexOption FromMutable(ScriptDom.FileStreamOnDropIndexOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.FileStreamOnDropIndexOption)) { throw new NotImplementedException("Unexpected subtype of FileStreamOnDropIndexOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
