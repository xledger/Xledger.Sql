...
namespace Xledger.Sql.ImmutableDom {
    public class LiteralPayloadOption : PayloadOption, IEquatable<LiteralPayloadOption> {
        ...
        public static bool operator < (LiteralPayloadOption left, LiteralPayloadOption right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(LiteralPayloadOption left, LiteralPayloadOption right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (LiteralPayloadOption left, LiteralPayloadOption right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(LiteralPayloadOption left, LiteralPayloadOption right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static LiteralPayloadOption FromMutable(ScriptDom.LiteralPayloadOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.LiteralPayloadOption)) { throw new NotImplementedException("Unexpected subtype of LiteralPayloadOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
