...
namespace Xledger.Sql.ImmutableDom {
    public class DropPartitionFunctionStatement : DropUnownedObjectStatement, IEquatable<DropPartitionFunctionStatement> {
        ...
        public override int CompareTo(TSqlFragment that) {
            ...
            var othr = (DropPartitionFunctionStatement)that;
        ...
        public static bool operator < (DropPartitionFunctionStatement left, DropPartitionFunctionStatement right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(DropPartitionFunctionStatement left, DropPartitionFunctionStatement right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (DropPartitionFunctionStatement left, DropPartitionFunctionStatement right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(DropPartitionFunctionStatement left, DropPartitionFunctionStatement right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static DropPartitionFunctionStatement FromMutable(ScriptDom.DropPartitionFunctionStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.DropPartitionFunctionStatement)) { throw new NotImplementedException("Unexpected subtype of DropPartitionFunctionStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
