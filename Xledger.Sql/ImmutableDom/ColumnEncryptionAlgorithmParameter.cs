...
namespace Xledger.Sql.ImmutableDom {
    public class ColumnEncryptionAlgorithmParameter : ColumnEncryptionDefinitionParameter, IEquatable<ColumnEncryptionAlgorithmParameter> {
        ...
        public static ColumnEncryptionAlgorithmParameter FromMutable(ScriptDom.ColumnEncryptionAlgorithmParameter fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.ColumnEncryptionAlgorithmParameter)) { throw new NotImplementedException("Unexpected subtype of ColumnEncryptionAlgorithmParameter not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new ColumnEncryptionAlgorithmParameter(
                encryptionAlgorithm: ImmutableDom.StringLiteral.FromMutable(fragment.EncryptionAlgorithm),
