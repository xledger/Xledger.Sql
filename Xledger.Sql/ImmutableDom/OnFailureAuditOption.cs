...
namespace Xledger.Sql.ImmutableDom {
    public class OnFailureAuditOption : AuditOption, IEquatable<OnFailureAuditOption> {
        ...
        public static OnFailureAuditOption FromMutable(ScriptDom.OnFailureAuditOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.OnFailureAuditOption)) { throw new NotImplementedException("Unexpected subtype of OnFailureAuditOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
