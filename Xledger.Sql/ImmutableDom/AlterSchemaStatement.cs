...
namespace Xledger.Sql.ImmutableDom {
    public class AlterSchemaStatement : TSqlStatement, IEquatable<AlterSchemaStatement> {
        ...
        public static AlterSchemaStatement FromMutable(ScriptDom.AlterSchemaStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.AlterSchemaStatement)) { throw new NotImplementedException("Unexpected subtype of AlterSchemaStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
