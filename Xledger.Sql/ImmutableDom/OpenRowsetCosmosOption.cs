...
namespace Xledger.Sql.ImmutableDom {
    public class OpenRowsetCosmosOption : TSqlFragment, IEquatable<OpenRowsetCosmosOption> {
        ...
        public static bool operator < (OpenRowsetCosmosOption left, OpenRowsetCosmosOption right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(OpenRowsetCosmosOption left, OpenRowsetCosmosOption right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (OpenRowsetCosmosOption left, OpenRowsetCosmosOption right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(OpenRowsetCosmosOption left, OpenRowsetCosmosOption right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static OpenRowsetCosmosOption FromMutable(ScriptDom.OpenRowsetCosmosOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.OpenRowsetCosmosOption)) { return TSqlFragment.FromMutable(fragment) as OpenRowsetCosmosOption; }
