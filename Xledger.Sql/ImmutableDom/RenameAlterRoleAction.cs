...
namespace Xledger.Sql.ImmutableDom {
    public class RenameAlterRoleAction : AlterRoleAction, IEquatable<RenameAlterRoleAction> {
        ...
        public static RenameAlterRoleAction FromMutable(ScriptDom.RenameAlterRoleAction fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.RenameAlterRoleAction)) { throw new NotImplementedException("Unexpected subtype of RenameAlterRoleAction not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
