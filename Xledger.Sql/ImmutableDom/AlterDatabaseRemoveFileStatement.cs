...
namespace Xledger.Sql.ImmutableDom {
    public class AlterDatabaseRemoveFileStatement : AlterDatabaseStatement, IEquatable<AlterDatabaseRemoveFileStatement> {
        ...
        public static AlterDatabaseRemoveFileStatement FromMutable(ScriptDom.AlterDatabaseRemoveFileStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.AlterDatabaseRemoveFileStatement)) { throw new NotImplementedException("Unexpected subtype of AlterDatabaseRemoveFileStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new AlterDatabaseRemoveFileStatement(
                file: ImmutableDom.Identifier.FromMutable(fragment.File),
