...
namespace Xledger.Sql.ImmutableDom {
    public class GridParameter : TSqlFragment, IEquatable<GridParameter> {
        ...
        public static GridParameter FromMutable(ScriptDom.GridParameter fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.GridParameter)) { throw new NotImplementedException("Unexpected subtype of GridParameter not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
