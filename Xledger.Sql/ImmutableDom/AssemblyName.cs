...
namespace Xledger.Sql.ImmutableDom {
    public class AssemblyName : TSqlFragment, IEquatable<AssemblyName> {
        ...
        public static bool operator < (AssemblyName left, AssemblyName right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(AssemblyName left, AssemblyName right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (AssemblyName left, AssemblyName right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(AssemblyName left, AssemblyName right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static AssemblyName FromMutable(ScriptDom.AssemblyName fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.AssemblyName)) { throw new NotImplementedException("Unexpected subtype of AssemblyName not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new AssemblyName(
                name: ImmutableDom.Identifier.FromMutable(fragment.Name),
                className: ImmutableDom.Identifier.FromMutable(fragment.ClassName)
            );
        }
