...
namespace Xledger.Sql.ImmutableDom {
    public class DropMemberAlterRoleAction : AlterRoleAction, IEquatable<DropMemberAlterRoleAction> {
        ...
        public static DropMemberAlterRoleAction FromMutable(ScriptDom.DropMemberAlterRoleAction fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.DropMemberAlterRoleAction)) { throw new NotImplementedException("Unexpected subtype of DropMemberAlterRoleAction not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
