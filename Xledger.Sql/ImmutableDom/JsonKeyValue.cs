...
namespace Xledger.Sql.ImmutableDom {
    public class JsonKeyValue : ScalarExpression, IEquatable<JsonKeyValue> {
        ...
        public override int CompareTo(TSqlFragment that) {
            ...
            compare = StructuralComparisons.StructuralComparer.Compare(this.jsonKeyName, othr.jsonKeyName);
            if (compare != 0) { return compare; }
            compare = StructuralComparisons.StructuralComparer.Compare(this.jsonValue, othr.jsonValue);
            if (compare != 0) { return compare; }
            return compare;
        } 
