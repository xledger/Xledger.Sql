...
namespace Xledger.Sql.ImmutableDom {
    public class JsonKeyValue : ScalarExpression, IEquatable<JsonKeyValue> {
        ...
        public static JsonKeyValue FromMutable(ScriptDom.JsonKeyValue fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.JsonKeyValue)) { throw new NotImplementedException("Unexpected subtype of JsonKeyValue not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new JsonKeyValue(
                jsonKeyName: ImmutableDom.ScalarExpression.FromMutable(fragment.JsonKeyName),
                jsonValue: ImmutableDom.ScalarExpression.FromMutable(fragment.JsonValue)
            );
        }
