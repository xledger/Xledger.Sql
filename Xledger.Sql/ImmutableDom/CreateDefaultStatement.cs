...
namespace Xledger.Sql.ImmutableDom {
    public class CreateDefaultStatement : TSqlStatement, IEquatable<CreateDefaultStatement> {
        ...
        public static CreateDefaultStatement FromMutable(ScriptDom.CreateDefaultStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.CreateDefaultStatement)) { throw new NotImplementedException("Unexpected subtype of CreateDefaultStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
