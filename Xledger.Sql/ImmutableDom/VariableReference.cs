...
namespace Xledger.Sql.ImmutableDom {
    public class VariableReference : ValueExpression, IEquatable<VariableReference> {
        ...
        public static VariableReference FromMutable(ScriptDom.VariableReference fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.VariableReference)) { throw new NotImplementedException("Unexpected subtype of VariableReference not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
