...
namespace Xledger.Sql.ImmutableDom {
    public class ExecuteAsStatement : TSqlStatement, IEquatable<ExecuteAsStatement> {
        ...
        public static ExecuteAsStatement FromMutable(ScriptDom.ExecuteAsStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.ExecuteAsStatement)) { throw new NotImplementedException("Unexpected subtype of ExecuteAsStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new ExecuteAsStatement(
                withNoRevert: fragment.WithNoRevert,
                cookie: ImmutableDom.VariableReference.FromMutable(fragment.Cookie),
