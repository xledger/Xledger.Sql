...
namespace Xledger.Sql.ImmutableDom {
    public class ExecuteAsStatement : TSqlStatement, IEquatable<ExecuteAsStatement> {
        ...
        public override int CompareTo(TSqlFragment that) {
            ...
            compare = StructuralComparisons.StructuralComparer.Compare(this.withNoRevert, othr.withNoRevert);
            if (compare != 0) { return compare; }
            compare = StructuralComparisons.StructuralComparer.Compare(this.cookie, othr.cookie);
            if (compare != 0) { return compare; }
