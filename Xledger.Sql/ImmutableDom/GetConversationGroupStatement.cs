...
namespace Xledger.Sql.ImmutableDom {
    public class GetConversationGroupStatement : WaitForSupportedStatement, IEquatable<GetConversationGroupStatement> {
        ...
        public static GetConversationGroupStatement FromMutable(ScriptDom.GetConversationGroupStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.GetConversationGroupStatement)) { throw new NotImplementedException("Unexpected subtype of GetConversationGroupStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new GetConversationGroupStatement(
                groupId: ImmutableDom.VariableReference.FromMutable(fragment.GroupId),
