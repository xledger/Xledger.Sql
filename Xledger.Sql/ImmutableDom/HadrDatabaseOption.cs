...
namespace Xledger.Sql.ImmutableDom {
    public class HadrDatabaseOption : DatabaseOption, IEquatable<HadrDatabaseOption> {
        ...
        public new ScriptDom.HadrDatabaseOption ToMutableConcrete() {
        ...
        public static HadrDatabaseOption FromMutable(ScriptDom.HadrDatabaseOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.HadrDatabaseOption)) { return TSqlFragment.FromMutable(fragment) as HadrDatabaseOption; }
