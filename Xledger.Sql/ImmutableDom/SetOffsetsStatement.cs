...
namespace Xledger.Sql.ImmutableDom {
    public class SetOffsetsStatement : SetOnOffStatement, IEquatable<SetOffsetsStatement> {
        ...
        public static SetOffsetsStatement FromMutable(ScriptDom.SetOffsetsStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.SetOffsetsStatement)) { throw new NotImplementedException("Unexpected subtype of SetOffsetsStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
