...
namespace Xledger.Sql.ImmutableDom {
    public class AlterPartitionFunctionStatement : TSqlStatement, IEquatable<AlterPartitionFunctionStatement> {
        ...
        public override int CompareTo(TSqlFragment that) {
            ...
            if (compare != 0) { return compare; }
            compare = StructuralComparisons.StructuralComparer.Compare(this.boundary, othr.boundary);
            if (compare != 0) { return compare; }
            return compare;
        } 
    
        public static AlterPartitionFunctionStatement FromMutable(ScriptDom.AlterPartitionFunctionStatement fragment) {
            return (AlterPartitionFunctionStatement)TSqlFragment.FromMutable(fragment);
        }
