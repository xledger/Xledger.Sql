...
namespace Xledger.Sql.ImmutableDom {
    public class DropSecurityPolicyStatement : DropObjectsStatement, IEquatable<DropSecurityPolicyStatement> {
        ...
        public static DropSecurityPolicyStatement FromMutable(ScriptDom.DropSecurityPolicyStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.DropSecurityPolicyStatement)) { throw new NotImplementedException("Unexpected subtype of DropSecurityPolicyStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
