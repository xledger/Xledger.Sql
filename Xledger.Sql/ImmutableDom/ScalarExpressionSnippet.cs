...
namespace Xledger.Sql.ImmutableDom {
    public class ScalarExpressionSnippet : ScalarExpression, IEquatable<ScalarExpressionSnippet> {
        ...
        public static bool operator < (ScalarExpressionSnippet left, ScalarExpressionSnippet right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(ScalarExpressionSnippet left, ScalarExpressionSnippet right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (ScalarExpressionSnippet left, ScalarExpressionSnippet right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(ScalarExpressionSnippet left, ScalarExpressionSnippet right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static ScalarExpressionSnippet FromMutable(ScriptDom.ScalarExpressionSnippet fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.ScalarExpressionSnippet)) { throw new NotImplementedException("Unexpected subtype of ScalarExpressionSnippet not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
