...
namespace Xledger.Sql.ImmutableDom {
    public class RevertStatement : TSqlStatement, IEquatable<RevertStatement> {
        ...
        public static RevertStatement FromMutable(ScriptDom.RevertStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.RevertStatement)) { throw new NotImplementedException("Unexpected subtype of RevertStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new RevertStatement(
                cookie: ImmutableDom.ScalarExpression.FromMutable(fragment.Cookie)
            );
        }
