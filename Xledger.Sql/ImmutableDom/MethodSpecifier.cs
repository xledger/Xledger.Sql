...
namespace Xledger.Sql.ImmutableDom {
    public class MethodSpecifier : TSqlFragment, IEquatable<MethodSpecifier> {
        ...
        public static MethodSpecifier FromMutable(ScriptDom.MethodSpecifier fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.MethodSpecifier)) { throw new NotImplementedException("Unexpected subtype of MethodSpecifier not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new MethodSpecifier(
                assemblyName: ImmutableDom.Identifier.FromMutable(fragment.AssemblyName),
