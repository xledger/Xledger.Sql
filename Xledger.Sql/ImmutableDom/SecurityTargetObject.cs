...
namespace Xledger.Sql.ImmutableDom {
    public class SecurityTargetObject : TSqlFragment, IEquatable<SecurityTargetObject> {
        ...
        public static SecurityTargetObject FromMutable(ScriptDom.SecurityTargetObject fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.SecurityTargetObject)) { throw new NotImplementedException("Unexpected subtype of SecurityTargetObject not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
