...
namespace Xledger.Sql.ImmutableDom {
    public class XmlForClauseOption : ForClause, IEquatable<XmlForClauseOption> {
        ...
        public static XmlForClauseOption FromMutable(ScriptDom.XmlForClauseOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.XmlForClauseOption)) { throw new NotImplementedException("Unexpected subtype of XmlForClauseOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
