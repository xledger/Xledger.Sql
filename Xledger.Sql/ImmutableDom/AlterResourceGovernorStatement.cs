...
namespace Xledger.Sql.ImmutableDom {
    public class AlterResourceGovernorStatement : TSqlStatement, IEquatable<AlterResourceGovernorStatement> {
        ...
        public static AlterResourceGovernorStatement FromMutable(ScriptDom.AlterResourceGovernorStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.AlterResourceGovernorStatement)) { throw new NotImplementedException("Unexpected subtype of AlterResourceGovernorStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new AlterResourceGovernorStatement(
                command: fragment.Command,
                classifierFunction: ImmutableDom.SchemaObjectName.FromMutable(fragment.ClassifierFunction)
            );
        }
