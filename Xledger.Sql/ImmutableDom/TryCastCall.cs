...
namespace Xledger.Sql.ImmutableDom {
    public class TryCastCall : PrimaryExpression, IEquatable<TryCastCall> {
        ...
        public static TryCastCall FromMutable(ScriptDom.TryCastCall fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.TryCastCall)) { throw new NotImplementedException("Unexpected subtype of TryCastCall not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
