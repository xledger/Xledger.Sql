...
namespace Xledger.Sql.ImmutableDom {
    public class ExpressionCallTarget : CallTarget, IEquatable<ExpressionCallTarget> {
        ...
        public static ExpressionCallTarget FromMutable(ScriptDom.ExpressionCallTarget fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.ExpressionCallTarget)) { throw new NotImplementedException("Unexpected subtype of ExpressionCallTarget not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
