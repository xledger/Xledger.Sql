...
namespace Xledger.Sql.ImmutableDom {
    public class RouteOption : TSqlFragment, IEquatable<RouteOption> {
        ...
        public static RouteOption FromMutable(ScriptDom.RouteOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.RouteOption)) { throw new NotImplementedException("Unexpected subtype of RouteOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
