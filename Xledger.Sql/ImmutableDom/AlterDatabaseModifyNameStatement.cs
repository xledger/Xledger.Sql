...
namespace Xledger.Sql.ImmutableDom {
    public class AlterDatabaseModifyNameStatement : AlterDatabaseStatement, IEquatable<AlterDatabaseModifyNameStatement> {
        ...
        public static AlterDatabaseModifyNameStatement FromMutable(ScriptDom.AlterDatabaseModifyNameStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.AlterDatabaseModifyNameStatement)) { throw new NotImplementedException("Unexpected subtype of AlterDatabaseModifyNameStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new AlterDatabaseModifyNameStatement(
                newDatabaseName: ImmutableDom.Identifier.FromMutable(fragment.NewDatabaseName),
