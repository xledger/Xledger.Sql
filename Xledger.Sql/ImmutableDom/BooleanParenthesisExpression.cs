...
namespace Xledger.Sql.ImmutableDom {
    public class BooleanParenthesisExpression : BooleanExpression, IEquatable<BooleanParenthesisExpression> {
        ...
        public static BooleanParenthesisExpression FromMutable(ScriptDom.BooleanParenthesisExpression fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.BooleanParenthesisExpression)) { throw new NotImplementedException("Unexpected subtype of BooleanParenthesisExpression not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
