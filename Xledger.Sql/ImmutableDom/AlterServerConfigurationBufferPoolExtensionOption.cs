...
namespace Xledger.Sql.ImmutableDom {
    public class AlterServerConfigurationBufferPoolExtensionOption : TSqlFragment, IEquatable<AlterServerConfigurationBufferPoolExtensionOption> {
        ...
        public static AlterServerConfigurationBufferPoolExtensionOption FromMutable(ScriptDom.AlterServerConfigurationBufferPoolExtensionOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.AlterServerConfigurationBufferPoolExtensionOption)) { return TSqlFragment.FromMutable(fragment) as AlterServerConfigurationBufferPoolExtensionOption; }
