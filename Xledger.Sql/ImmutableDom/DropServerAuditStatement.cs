...
namespace Xledger.Sql.ImmutableDom {
    public class DropServerAuditStatement : DropUnownedObjectStatement, IEquatable<DropServerAuditStatement> {
        ...
        public static DropServerAuditStatement FromMutable(ScriptDom.DropServerAuditStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.DropServerAuditStatement)) { throw new NotImplementedException("Unexpected subtype of DropServerAuditStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
