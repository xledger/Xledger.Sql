...
namespace Xledger.Sql.ImmutableDom {
    public class DropRouteStatement : DropUnownedObjectStatement, IEquatable<DropRouteStatement> {
        ...
        public static DropRouteStatement FromMutable(ScriptDom.DropRouteStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.DropRouteStatement)) { throw new NotImplementedException("Unexpected subtype of DropRouteStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
