...
namespace Xledger.Sql.ImmutableDom {
    public class DatabaseAuditAction : TSqlFragment, IEquatable<DatabaseAuditAction> {
        ...
        public static DatabaseAuditAction FromMutable(ScriptDom.DatabaseAuditAction fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.DatabaseAuditAction)) { throw new NotImplementedException("Unexpected subtype of DatabaseAuditAction not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
