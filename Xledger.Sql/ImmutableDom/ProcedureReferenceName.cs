...
namespace Xledger.Sql.ImmutableDom {
    public class ProcedureReferenceName : TSqlFragment, IEquatable<ProcedureReferenceName> {
        ...
        public static ProcedureReferenceName FromMutable(ScriptDom.ProcedureReferenceName fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.ProcedureReferenceName)) { throw new NotImplementedException("Unexpected subtype of ProcedureReferenceName not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new ProcedureReferenceName(
                ...
                procedureVariable: ImmutableDom.VariableReference.FromMutable(fragment.ProcedureVariable)
            );
        }
