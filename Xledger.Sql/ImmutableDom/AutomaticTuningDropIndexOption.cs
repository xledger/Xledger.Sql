...
namespace Xledger.Sql.ImmutableDom {
    public class AutomaticTuningDropIndexOption : AutomaticTuningOption, IEquatable<AutomaticTuningDropIndexOption> {
        ...
        public new ScriptDom.AutomaticTuningDropIndexOption ToMutableConcrete() {
        ...
        public static bool operator < (AutomaticTuningDropIndexOption left, AutomaticTuningDropIndexOption right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(AutomaticTuningDropIndexOption left, AutomaticTuningDropIndexOption right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (AutomaticTuningDropIndexOption left, AutomaticTuningDropIndexOption right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(AutomaticTuningDropIndexOption left, AutomaticTuningDropIndexOption right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static AutomaticTuningDropIndexOption FromMutable(ScriptDom.AutomaticTuningDropIndexOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.AutomaticTuningDropIndexOption)) { throw new NotImplementedException("Unexpected subtype of AutomaticTuningDropIndexOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
