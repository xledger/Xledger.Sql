...
namespace Xledger.Sql.ImmutableDom {
    public abstract class FullTextCatalogStatement : TSqlStatement {
        ...
        public static FullTextCatalogStatement FromMutable(ScriptDom.FullTextCatalogStatement fragment) {
            return (FullTextCatalogStatement)TSqlFragment.FromMutable(fragment);
        }
