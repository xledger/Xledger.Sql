...
namespace Xledger.Sql.ImmutableDom {
    public class LineNoStatement : TSqlStatement, IEquatable<LineNoStatement> {
        ...
        public static LineNoStatement FromMutable(ScriptDom.LineNoStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.LineNoStatement)) { throw new NotImplementedException("Unexpected subtype of LineNoStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new LineNoStatement(
                lineNo: ImmutableDom.IntegerLiteral.FromMutable(fragment.LineNo)
            );
        }
