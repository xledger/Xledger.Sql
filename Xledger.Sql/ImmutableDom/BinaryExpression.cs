...
namespace Xledger.Sql.ImmutableDom {
    public class BinaryExpression : ScalarExpression, IEquatable<BinaryExpression> {
        ...
        public static BinaryExpression FromMutable(ScriptDom.BinaryExpression fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.BinaryExpression)) { throw new NotImplementedException("Unexpected subtype of BinaryExpression not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
