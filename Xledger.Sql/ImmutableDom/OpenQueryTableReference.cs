...
namespace Xledger.Sql.ImmutableDom {
    public class OpenQueryTableReference : TableReferenceWithAlias, IEquatable<OpenQueryTableReference> {
        ...
        public static bool operator < (OpenQueryTableReference left, OpenQueryTableReference right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(OpenQueryTableReference left, OpenQueryTableReference right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (OpenQueryTableReference left, OpenQueryTableReference right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(OpenQueryTableReference left, OpenQueryTableReference right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static OpenQueryTableReference FromMutable(ScriptDom.OpenQueryTableReference fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.OpenQueryTableReference)) { throw new NotImplementedException("Unexpected subtype of OpenQueryTableReference not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
