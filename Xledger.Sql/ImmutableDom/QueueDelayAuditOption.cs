...
namespace Xledger.Sql.ImmutableDom {
    public class QueueDelayAuditOption : AuditOption, IEquatable<QueueDelayAuditOption> {
        ...
        public override int CompareTo(TSqlFragment that) {
            ...
            compare = Comparer.DefaultInvariant.Compare(this.delay, othr.delay);
        ...
        public static QueueDelayAuditOption FromMutable(ScriptDom.QueueDelayAuditOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.QueueDelayAuditOption)) { throw new NotImplementedException("Unexpected subtype of QueueDelayAuditOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new QueueDelayAuditOption(
                delay: ImmutableDom.Literal.FromMutable(fragment.Delay),
