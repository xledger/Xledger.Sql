...
namespace Xledger.Sql.ImmutableDom {
    public class NullLiteral : Literal, IEquatable<NullLiteral> {
        ...
        public static NullLiteral FromMutable(ScriptDom.NullLiteral fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.NullLiteral)) { throw new NotImplementedException("Unexpected subtype of NullLiteral not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
