...
namespace Xledger.Sql.ImmutableDom {
    public class DropXmlSchemaCollectionStatement : TSqlStatement, IEquatable<DropXmlSchemaCollectionStatement> {
        ...
        public static DropXmlSchemaCollectionStatement FromMutable(ScriptDom.DropXmlSchemaCollectionStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.DropXmlSchemaCollectionStatement)) { throw new NotImplementedException("Unexpected subtype of DropXmlSchemaCollectionStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
