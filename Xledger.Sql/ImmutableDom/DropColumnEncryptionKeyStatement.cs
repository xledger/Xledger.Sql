...
namespace Xledger.Sql.ImmutableDom {
    public class DropColumnEncryptionKeyStatement : DropUnownedObjectStatement, IEquatable<DropColumnEncryptionKeyStatement> {
        ...
        public override int CompareTo(TSqlFragment that) {
            ...
            var othr = (DropColumnEncryptionKeyStatement)that;
        ...
        public static bool operator < (DropColumnEncryptionKeyStatement left, DropColumnEncryptionKeyStatement right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(DropColumnEncryptionKeyStatement left, DropColumnEncryptionKeyStatement right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (DropColumnEncryptionKeyStatement left, DropColumnEncryptionKeyStatement right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(DropColumnEncryptionKeyStatement left, DropColumnEncryptionKeyStatement right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static DropColumnEncryptionKeyStatement FromMutable(ScriptDom.DropColumnEncryptionKeyStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.DropColumnEncryptionKeyStatement)) { throw new NotImplementedException("Unexpected subtype of DropColumnEncryptionKeyStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
