...
namespace Xledger.Sql.ImmutableDom {
    public class PrimaryRoleReplicaOption : AvailabilityReplicaOption, IEquatable<PrimaryRoleReplicaOption> {
        ...
        public static PrimaryRoleReplicaOption FromMutable(ScriptDom.PrimaryRoleReplicaOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.PrimaryRoleReplicaOption)) { throw new NotImplementedException("Unexpected subtype of PrimaryRoleReplicaOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
