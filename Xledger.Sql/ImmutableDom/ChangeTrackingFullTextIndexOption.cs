...
namespace Xledger.Sql.ImmutableDom {
    public class ChangeTrackingFullTextIndexOption : FullTextIndexOption, IEquatable<ChangeTrackingFullTextIndexOption> {
        ...
        public static ChangeTrackingFullTextIndexOption FromMutable(ScriptDom.ChangeTrackingFullTextIndexOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.ChangeTrackingFullTextIndexOption)) { throw new NotImplementedException("Unexpected subtype of ChangeTrackingFullTextIndexOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
