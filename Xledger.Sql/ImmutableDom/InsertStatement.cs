...
namespace Xledger.Sql.ImmutableDom {
    public class InsertStatement : DataModificationStatement, IEquatable<InsertStatement> {
        ...
        public static InsertStatement FromMutable(ScriptDom.InsertStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.InsertStatement)) { throw new NotImplementedException("Unexpected subtype of InsertStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new InsertStatement(
                insertSpecification: ImmutableDom.InsertSpecification.FromMutable(fragment.InsertSpecification),
