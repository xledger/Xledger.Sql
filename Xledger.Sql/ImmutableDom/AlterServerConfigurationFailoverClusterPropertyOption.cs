...
namespace Xledger.Sql.ImmutableDom {
    public class AlterServerConfigurationFailoverClusterPropertyOption : TSqlFragment, IEquatable<AlterServerConfigurationFailoverClusterPropertyOption> {
        ...
        public static AlterServerConfigurationFailoverClusterPropertyOption FromMutable(ScriptDom.AlterServerConfigurationFailoverClusterPropertyOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.AlterServerConfigurationFailoverClusterPropertyOption)) { throw new NotImplementedException("Unexpected subtype of AlterServerConfigurationFailoverClusterPropertyOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
