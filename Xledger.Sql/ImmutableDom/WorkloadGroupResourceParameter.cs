...
namespace Xledger.Sql.ImmutableDom {
    public class WorkloadGroupResourceParameter : WorkloadGroupParameter, IEquatable<WorkloadGroupResourceParameter> {
        ...
        public static bool operator < (WorkloadGroupResourceParameter left, WorkloadGroupResourceParameter right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(WorkloadGroupResourceParameter left, WorkloadGroupResourceParameter right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (WorkloadGroupResourceParameter left, WorkloadGroupResourceParameter right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(WorkloadGroupResourceParameter left, WorkloadGroupResourceParameter right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static WorkloadGroupResourceParameter FromMutable(ScriptDom.WorkloadGroupResourceParameter fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.WorkloadGroupResourceParameter)) { throw new NotImplementedException("Unexpected subtype of WorkloadGroupResourceParameter not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
