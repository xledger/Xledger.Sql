...
namespace Xledger.Sql.ImmutableDom {
    public class ParenthesisExpression : PrimaryExpression, IEquatable<ParenthesisExpression> {
        ...
        public static ParenthesisExpression FromMutable(ScriptDom.ParenthesisExpression fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.ParenthesisExpression)) { throw new NotImplementedException("Unexpected subtype of ParenthesisExpression not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
