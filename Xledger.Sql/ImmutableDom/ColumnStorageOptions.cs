...
namespace Xledger.Sql.ImmutableDom {
    public class ColumnStorageOptions : TSqlFragment, IEquatable<ColumnStorageOptions> {
        ...
        public override int CompareTo(TSqlFragment that) {
            ...
            compare = StructuralComparisons.StructuralComparer.Compare(this.isFileStream, othr.isFileStream);
            if (compare != 0) { return compare; }
            compare = StructuralComparisons.StructuralComparer.Compare(this.sparseOption, othr.sparseOption);
            if (compare != 0) { return compare; }
            return compare;
        } 
