...
namespace Xledger.Sql.ImmutableDom {
    public class AlterDatabaseScopedConfigurationClearStatement : AlterDatabaseScopedConfigurationStatement, IEquatable<AlterDatabaseScopedConfigurationClearStatement> {
        ...
        public static AlterDatabaseScopedConfigurationClearStatement FromMutable(ScriptDom.AlterDatabaseScopedConfigurationClearStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.AlterDatabaseScopedConfigurationClearStatement)) { throw new NotImplementedException("Unexpected subtype of AlterDatabaseScopedConfigurationClearStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new AlterDatabaseScopedConfigurationClearStatement(
                option: ImmutableDom.DatabaseConfigurationClearOption.FromMutable(fragment.Option),
