...
namespace Xledger.Sql.ImmutableDom {
    public class TableDistributionOption : TableOption, IEquatable<TableDistributionOption> {
        ...
        public static TableDistributionOption FromMutable(ScriptDom.TableDistributionOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.TableDistributionOption)) { throw new NotImplementedException("Unexpected subtype of TableDistributionOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new TableDistributionOption(
                @value: ImmutableDom.TableDistributionPolicy.FromMutable(fragment.Value),
