...
namespace Xledger.Sql.ImmutableDom {
    public class SetStopListAlterFullTextIndexAction : AlterFullTextIndexAction, IEquatable<SetStopListAlterFullTextIndexAction> {
        ...
        public static SetStopListAlterFullTextIndexAction FromMutable(ScriptDom.SetStopListAlterFullTextIndexAction fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.SetStopListAlterFullTextIndexAction)) { throw new NotImplementedException("Unexpected subtype of SetStopListAlterFullTextIndexAction not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new SetStopListAlterFullTextIndexAction(
                stopListOption: ImmutableDom.StopListFullTextIndexOption.FromMutable(fragment.StopListOption),
