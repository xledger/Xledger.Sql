...
namespace Xledger.Sql.ImmutableDom {
    public class BulkInsertStatement : BulkInsertBase, IEquatable<BulkInsertStatement> {
        ...
        public static BulkInsertStatement FromMutable(ScriptDom.BulkInsertStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.BulkInsertStatement)) { throw new NotImplementedException("Unexpected subtype of BulkInsertStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
