...
namespace Xledger.Sql.ImmutableDom {
    public class StateAuditOption : AuditOption, IEquatable<StateAuditOption> {
        ...
        public static StateAuditOption FromMutable(ScriptDom.StateAuditOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.StateAuditOption)) { throw new NotImplementedException("Unexpected subtype of StateAuditOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
