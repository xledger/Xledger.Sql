...
namespace Xledger.Sql.ImmutableDom {
    public class RolePayloadOption : PayloadOption, IEquatable<RolePayloadOption> {
        ...
        public static RolePayloadOption FromMutable(ScriptDom.RolePayloadOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.RolePayloadOption)) { throw new NotImplementedException("Unexpected subtype of RolePayloadOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
