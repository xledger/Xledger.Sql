...
namespace Xledger.Sql.ImmutableDom {
    public class DropFullTextStopListStatement : DropUnownedObjectStatement, IEquatable<DropFullTextStopListStatement> {
        ...
        public override int CompareTo(TSqlFragment that) {
            ...
            var othr = (DropFullTextStopListStatement)that;
        ...
        public static bool operator < (DropFullTextStopListStatement left, DropFullTextStopListStatement right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(DropFullTextStopListStatement left, DropFullTextStopListStatement right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (DropFullTextStopListStatement left, DropFullTextStopListStatement right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(DropFullTextStopListStatement left, DropFullTextStopListStatement right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static DropFullTextStopListStatement FromMutable(ScriptDom.DropFullTextStopListStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.DropFullTextStopListStatement)) { throw new NotImplementedException("Unexpected subtype of DropFullTextStopListStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
