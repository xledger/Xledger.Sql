...
namespace Xledger.Sql.ImmutableDom {
    public class EventRetentionSessionOption : SessionOption, IEquatable<EventRetentionSessionOption> {
        ...
        public static EventRetentionSessionOption FromMutable(ScriptDom.EventRetentionSessionOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.EventRetentionSessionOption)) { throw new NotImplementedException("Unexpected subtype of EventRetentionSessionOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
