...
namespace Xledger.Sql.ImmutableDom {
    public class DropContractStatement : DropUnownedObjectStatement, IEquatable<DropContractStatement> {
        ...
        public override int CompareTo(TSqlFragment that) {
            ...
            var othr = (DropContractStatement)that;
        ...
        public static bool operator < (DropContractStatement left, DropContractStatement right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(DropContractStatement left, DropContractStatement right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (DropContractStatement left, DropContractStatement right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(DropContractStatement left, DropContractStatement right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static DropContractStatement FromMutable(ScriptDom.DropContractStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.DropContractStatement)) { throw new NotImplementedException("Unexpected subtype of DropContractStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
