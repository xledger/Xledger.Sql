...
namespace Xledger.Sql.ImmutableDom {
    public class PartitionSpecifier : TSqlFragment, IEquatable<PartitionSpecifier> {
        ...
        public static PartitionSpecifier FromMutable(ScriptDom.PartitionSpecifier fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.PartitionSpecifier)) { throw new NotImplementedException("Unexpected subtype of PartitionSpecifier not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new PartitionSpecifier(
                number: ImmutableDom.ScalarExpression.FromMutable(fragment.Number),
                all: fragment.All
            );
        }
