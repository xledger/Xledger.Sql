...
namespace Xledger.Sql.ImmutableDom {
    public class ColumnMasterKeyNameParameter : ColumnEncryptionKeyValueParameter, IEquatable<ColumnMasterKeyNameParameter> {
        ...
        public static ColumnMasterKeyNameParameter FromMutable(ScriptDom.ColumnMasterKeyNameParameter fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.ColumnMasterKeyNameParameter)) { throw new NotImplementedException("Unexpected subtype of ColumnMasterKeyNameParameter not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
