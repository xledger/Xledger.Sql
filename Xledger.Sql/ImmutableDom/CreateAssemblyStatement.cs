...
namespace Xledger.Sql.ImmutableDom {
    public class CreateAssemblyStatement : AssemblyStatement, IEquatable<CreateAssemblyStatement> {
        ...
        public static CreateAssemblyStatement FromMutable(ScriptDom.CreateAssemblyStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.CreateAssemblyStatement)) { throw new NotImplementedException("Unexpected subtype of CreateAssemblyStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
