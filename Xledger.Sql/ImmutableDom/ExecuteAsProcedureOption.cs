...
namespace Xledger.Sql.ImmutableDom {
    public class ExecuteAsProcedureOption : ProcedureOption, IEquatable<ExecuteAsProcedureOption> {
        ...
        public new ScriptDom.ExecuteAsProcedureOption ToMutableConcrete() {
        ...
        public static ExecuteAsProcedureOption FromMutable(ScriptDom.ExecuteAsProcedureOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.ExecuteAsProcedureOption)) { throw new NotImplementedException("Unexpected subtype of ExecuteAsProcedureOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
