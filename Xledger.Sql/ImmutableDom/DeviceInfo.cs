...
namespace Xledger.Sql.ImmutableDom {
    public class DeviceInfo : TSqlFragment, IEquatable<DeviceInfo> {
        ...
        public static DeviceInfo FromMutable(ScriptDom.DeviceInfo fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.DeviceInfo)) { throw new NotImplementedException("Unexpected subtype of DeviceInfo not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new DeviceInfo(
                logicalDevice: ImmutableDom.IdentifierOrValueExpression.FromMutable(fragment.LogicalDevice),
                physicalDevice: ImmutableDom.ValueExpression.FromMutable(fragment.PhysicalDevice),
