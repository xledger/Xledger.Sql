...
namespace Xledger.Sql.ImmutableDom {
    public class RealLiteral : Literal, IEquatable<RealLiteral> {
        ...
        public static bool operator < (RealLiteral left, RealLiteral right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(RealLiteral left, RealLiteral right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (RealLiteral left, RealLiteral right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(RealLiteral left, RealLiteral right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static RealLiteral FromMutable(ScriptDom.RealLiteral fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.RealLiteral)) { throw new NotImplementedException("Unexpected subtype of RealLiteral not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
