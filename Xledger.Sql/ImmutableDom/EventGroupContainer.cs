...
namespace Xledger.Sql.ImmutableDom {
    public class EventGroupContainer : EventTypeGroupContainer, IEquatable<EventGroupContainer> {
        ...
        public static EventGroupContainer FromMutable(ScriptDom.EventGroupContainer fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.EventGroupContainer)) { throw new NotImplementedException("Unexpected subtype of EventGroupContainer not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
