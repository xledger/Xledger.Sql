...
namespace Xledger.Sql.ImmutableDom {
    public class AlterDatabaseRebuildLogStatement : AlterDatabaseStatement, IEquatable<AlterDatabaseRebuildLogStatement> {
        ...
        public static AlterDatabaseRebuildLogStatement FromMutable(ScriptDom.AlterDatabaseRebuildLogStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.AlterDatabaseRebuildLogStatement)) { throw new NotImplementedException("Unexpected subtype of AlterDatabaseRebuildLogStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
