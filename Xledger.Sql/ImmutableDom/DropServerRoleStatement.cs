...
namespace Xledger.Sql.ImmutableDom {
    public class DropServerRoleStatement : DropUnownedObjectStatement, IEquatable<DropServerRoleStatement> {
        ...
        public override int CompareTo(TSqlFragment that) {
            ...
            var othr = (DropServerRoleStatement)that;
        ...
        public static bool operator < (DropServerRoleStatement left, DropServerRoleStatement right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(DropServerRoleStatement left, DropServerRoleStatement right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (DropServerRoleStatement left, DropServerRoleStatement right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(DropServerRoleStatement left, DropServerRoleStatement right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static DropServerRoleStatement FromMutable(ScriptDom.DropServerRoleStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.DropServerRoleStatement)) { throw new NotImplementedException("Unexpected subtype of DropServerRoleStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
