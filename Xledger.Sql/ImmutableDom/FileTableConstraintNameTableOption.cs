...
namespace Xledger.Sql.ImmutableDom {
    public class FileTableConstraintNameTableOption : TableOption, IEquatable<FileTableConstraintNameTableOption> {
        ...
        public static FileTableConstraintNameTableOption FromMutable(ScriptDom.FileTableConstraintNameTableOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.FileTableConstraintNameTableOption)) { throw new NotImplementedException("Unexpected subtype of FileTableConstraintNameTableOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
