...
namespace Xledger.Sql.ImmutableDom {
    public class CursorDefaultDatabaseOption : DatabaseOption, IEquatable<CursorDefaultDatabaseOption> {
        ...
        public new ScriptDom.CursorDefaultDatabaseOption ToMutableConcrete() {
        ...
        public static CursorDefaultDatabaseOption FromMutable(ScriptDom.CursorDefaultDatabaseOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.CursorDefaultDatabaseOption)) { throw new NotImplementedException("Unexpected subtype of CursorDefaultDatabaseOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
