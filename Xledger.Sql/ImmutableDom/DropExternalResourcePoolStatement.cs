...
namespace Xledger.Sql.ImmutableDom {
    public class DropExternalResourcePoolStatement : DropUnownedObjectStatement, IEquatable<DropExternalResourcePoolStatement> {
        ...
        public static DropExternalResourcePoolStatement FromMutable(ScriptDom.DropExternalResourcePoolStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.DropExternalResourcePoolStatement)) { throw new NotImplementedException("Unexpected subtype of DropExternalResourcePoolStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
