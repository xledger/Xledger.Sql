...
namespace Xledger.Sql.ImmutableDom {
    public class ExternalFileFormatLiteralOption : ExternalFileFormatOption, IEquatable<ExternalFileFormatLiteralOption> {
        ...
        public override int CompareTo(TSqlFragment that) {
            ...
            var othr = (ExternalFileFormatLiteralOption)that;
        ...
        public static bool operator < (ExternalFileFormatLiteralOption left, ExternalFileFormatLiteralOption right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(ExternalFileFormatLiteralOption left, ExternalFileFormatLiteralOption right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (ExternalFileFormatLiteralOption left, ExternalFileFormatLiteralOption right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(ExternalFileFormatLiteralOption left, ExternalFileFormatLiteralOption right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static ExternalFileFormatLiteralOption FromMutable(ScriptDom.ExternalFileFormatLiteralOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.ExternalFileFormatLiteralOption)) { throw new NotImplementedException("Unexpected subtype of ExternalFileFormatLiteralOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
