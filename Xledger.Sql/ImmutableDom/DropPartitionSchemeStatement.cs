...
namespace Xledger.Sql.ImmutableDom {
    public class DropPartitionSchemeStatement : DropUnownedObjectStatement, IEquatable<DropPartitionSchemeStatement> {
        ...
        public override int CompareTo(TSqlFragment that) {
            ...
            var othr = (DropPartitionSchemeStatement)that;
        ...
        public static bool operator < (DropPartitionSchemeStatement left, DropPartitionSchemeStatement right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(DropPartitionSchemeStatement left, DropPartitionSchemeStatement right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (DropPartitionSchemeStatement left, DropPartitionSchemeStatement right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(DropPartitionSchemeStatement left, DropPartitionSchemeStatement right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static DropPartitionSchemeStatement FromMutable(ScriptDom.DropPartitionSchemeStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.DropPartitionSchemeStatement)) { throw new NotImplementedException("Unexpected subtype of DropPartitionSchemeStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
