...
namespace Xledger.Sql.ImmutableDom {
    public class IdentifierAtomicBlockOption : AtomicBlockOption, IEquatable<IdentifierAtomicBlockOption> {
        ...
        public override int CompareTo(TSqlFragment that) {
            ...
            var othr = (IdentifierAtomicBlockOption)that;
        ...
        public static bool operator < (IdentifierAtomicBlockOption left, IdentifierAtomicBlockOption right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(IdentifierAtomicBlockOption left, IdentifierAtomicBlockOption right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (IdentifierAtomicBlockOption left, IdentifierAtomicBlockOption right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(IdentifierAtomicBlockOption left, IdentifierAtomicBlockOption right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static IdentifierAtomicBlockOption FromMutable(ScriptDom.IdentifierAtomicBlockOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.IdentifierAtomicBlockOption)) { throw new NotImplementedException("Unexpected subtype of IdentifierAtomicBlockOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
