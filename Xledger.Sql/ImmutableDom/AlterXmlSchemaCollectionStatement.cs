...
namespace Xledger.Sql.ImmutableDom {
    public class AlterXmlSchemaCollectionStatement : TSqlStatement, IEquatable<AlterXmlSchemaCollectionStatement> {
        ...
        public static AlterXmlSchemaCollectionStatement FromMutable(ScriptDom.AlterXmlSchemaCollectionStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.AlterXmlSchemaCollectionStatement)) { throw new NotImplementedException("Unexpected subtype of AlterXmlSchemaCollectionStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
