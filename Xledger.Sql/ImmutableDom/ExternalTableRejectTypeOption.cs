...
namespace Xledger.Sql.ImmutableDom {
    public class ExternalTableRejectTypeOption : ExternalTableOption, IEquatable<ExternalTableRejectTypeOption> {
        ...
        public static ExternalTableRejectTypeOption FromMutable(ScriptDom.ExternalTableRejectTypeOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.ExternalTableRejectTypeOption)) { throw new NotImplementedException("Unexpected subtype of ExternalTableRejectTypeOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
