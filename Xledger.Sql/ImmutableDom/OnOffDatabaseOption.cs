...
namespace Xledger.Sql.ImmutableDom {
    public class OnOffDatabaseOption : DatabaseOption, IEquatable<OnOffDatabaseOption> {
        ...
        public new ScriptDom.OnOffDatabaseOption ToMutableConcrete() {
        ...
        public static OnOffDatabaseOption FromMutable(ScriptDom.OnOffDatabaseOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.OnOffDatabaseOption)) { return TSqlFragment.FromMutable(fragment) as OnOffDatabaseOption; }
