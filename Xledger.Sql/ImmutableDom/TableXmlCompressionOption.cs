...
namespace Xledger.Sql.ImmutableDom {
    public class TableXmlCompressionOption : TableOption, IEquatable<TableXmlCompressionOption> {
        ...
        public static TableXmlCompressionOption FromMutable(ScriptDom.TableXmlCompressionOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.TableXmlCompressionOption)) { throw new NotImplementedException("Unexpected subtype of TableXmlCompressionOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new TableXmlCompressionOption(
                xmlCompressionOption: ImmutableDom.XmlCompressionOption.FromMutable(fragment.XmlCompressionOption),
