...
namespace Xledger.Sql.ImmutableDom {
    public class AlterFullTextIndexStatement : TSqlStatement, IEquatable<AlterFullTextIndexStatement> {
        ...
        public static bool operator < (AlterFullTextIndexStatement left, AlterFullTextIndexStatement right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(AlterFullTextIndexStatement left, AlterFullTextIndexStatement right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (AlterFullTextIndexStatement left, AlterFullTextIndexStatement right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(AlterFullTextIndexStatement left, AlterFullTextIndexStatement right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static AlterFullTextIndexStatement FromMutable(ScriptDom.AlterFullTextIndexStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.AlterFullTextIndexStatement)) { throw new NotImplementedException("Unexpected subtype of AlterFullTextIndexStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new AlterFullTextIndexStatement(
                onName: ImmutableDom.SchemaObjectName.FromMutable(fragment.OnName),
                action: ImmutableDom.AlterFullTextIndexAction.FromMutable(fragment.Action)
            );
        }
