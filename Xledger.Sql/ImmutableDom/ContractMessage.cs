...
namespace Xledger.Sql.ImmutableDom {
    public class ContractMessage : TSqlFragment, IEquatable<ContractMessage> {
        ...
        public static ContractMessage FromMutable(ScriptDom.ContractMessage fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.ContractMessage)) { throw new NotImplementedException("Unexpected subtype of ContractMessage not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
