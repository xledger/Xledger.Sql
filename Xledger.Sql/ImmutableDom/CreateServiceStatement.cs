...
namespace Xledger.Sql.ImmutableDom {
    public class CreateServiceStatement : AlterCreateServiceStatementBase, IEquatable<CreateServiceStatement> {
        ...
        public static CreateServiceStatement FromMutable(ScriptDom.CreateServiceStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.CreateServiceStatement)) { throw new NotImplementedException("Unexpected subtype of CreateServiceStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
