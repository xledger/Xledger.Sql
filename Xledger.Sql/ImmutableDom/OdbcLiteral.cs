...
namespace Xledger.Sql.ImmutableDom {
    public class OdbcLiteral : Literal, IEquatable<OdbcLiteral> {
        ...
        public static OdbcLiteral FromMutable(ScriptDom.OdbcLiteral fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.OdbcLiteral)) { throw new NotImplementedException("Unexpected subtype of OdbcLiteral not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
