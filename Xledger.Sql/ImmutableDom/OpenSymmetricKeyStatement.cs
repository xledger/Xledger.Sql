...
namespace Xledger.Sql.ImmutableDom {
    public class OpenSymmetricKeyStatement : TSqlStatement, IEquatable<OpenSymmetricKeyStatement> {
        ...
        public static OpenSymmetricKeyStatement FromMutable(ScriptDom.OpenSymmetricKeyStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.OpenSymmetricKeyStatement)) { throw new NotImplementedException("Unexpected subtype of OpenSymmetricKeyStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new OpenSymmetricKeyStatement(
                name: ImmutableDom.Identifier.FromMutable(fragment.Name),
                decryptionMechanism: ImmutableDom.CryptoMechanism.FromMutable(fragment.DecryptionMechanism)
            );
        }
