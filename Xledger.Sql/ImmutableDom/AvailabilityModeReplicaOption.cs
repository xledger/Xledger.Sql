...
namespace Xledger.Sql.ImmutableDom {
    public class AvailabilityModeReplicaOption : AvailabilityReplicaOption, IEquatable<AvailabilityModeReplicaOption> {
        ...
        public static AvailabilityModeReplicaOption FromMutable(ScriptDom.AvailabilityModeReplicaOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.AvailabilityModeReplicaOption)) { throw new NotImplementedException("Unexpected subtype of AvailabilityModeReplicaOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
