...
namespace Xledger.Sql.ImmutableDom {
    public class DropExternalDataSourceStatement : DropUnownedObjectStatement, IEquatable<DropExternalDataSourceStatement> {
        ...
        public override int CompareTo(TSqlFragment that) {
            ...
            var othr = (DropExternalDataSourceStatement)that;
        ...
        public static bool operator < (DropExternalDataSourceStatement left, DropExternalDataSourceStatement right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(DropExternalDataSourceStatement left, DropExternalDataSourceStatement right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (DropExternalDataSourceStatement left, DropExternalDataSourceStatement right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(DropExternalDataSourceStatement left, DropExternalDataSourceStatement right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static DropExternalDataSourceStatement FromMutable(ScriptDom.DropExternalDataSourceStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.DropExternalDataSourceStatement)) { throw new NotImplementedException("Unexpected subtype of DropExternalDataSourceStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
