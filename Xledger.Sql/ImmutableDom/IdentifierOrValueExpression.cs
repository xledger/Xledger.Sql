...
namespace Xledger.Sql.ImmutableDom {
    public class IdentifierOrValueExpression : TSqlFragment, IEquatable<IdentifierOrValueExpression> {
        ...
        public static IdentifierOrValueExpression FromMutable(ScriptDom.IdentifierOrValueExpression fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.IdentifierOrValueExpression)) { throw new NotImplementedException("Unexpected subtype of IdentifierOrValueExpression not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
