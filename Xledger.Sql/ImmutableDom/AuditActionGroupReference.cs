...
namespace Xledger.Sql.ImmutableDom {
    public class AuditActionGroupReference : AuditSpecificationDetail, IEquatable<AuditActionGroupReference> {
        ...
        public static bool operator < (AuditActionGroupReference left, AuditActionGroupReference right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(AuditActionGroupReference left, AuditActionGroupReference right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (AuditActionGroupReference left, AuditActionGroupReference right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(AuditActionGroupReference left, AuditActionGroupReference right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static AuditActionGroupReference FromMutable(ScriptDom.AuditActionGroupReference fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.AuditActionGroupReference)) { throw new NotImplementedException("Unexpected subtype of AuditActionGroupReference not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
