...
namespace Xledger.Sql.ImmutableDom {
    public class DropMessageTypeStatement : DropUnownedObjectStatement, IEquatable<DropMessageTypeStatement> {
        ...
        public override int CompareTo(TSqlFragment that) {
            ...
            var othr = (DropMessageTypeStatement)that;
        ...
        public static bool operator < (DropMessageTypeStatement left, DropMessageTypeStatement right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(DropMessageTypeStatement left, DropMessageTypeStatement right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (DropMessageTypeStatement left, DropMessageTypeStatement right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(DropMessageTypeStatement left, DropMessageTypeStatement right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static DropMessageTypeStatement FromMutable(ScriptDom.DropMessageTypeStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.DropMessageTypeStatement)) { throw new NotImplementedException("Unexpected subtype of DropMessageTypeStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
