...
namespace Xledger.Sql.ImmutableDom {
    public class MaxDurationOption : IndexOption, IEquatable<MaxDurationOption> {
        ...
        public static MaxDurationOption FromMutable(ScriptDom.MaxDurationOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.MaxDurationOption)) { throw new NotImplementedException("Unexpected subtype of MaxDurationOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
