...
namespace Xledger.Sql.ImmutableDom {
    public class CreateTypeUdtStatement : CreateTypeStatement, IEquatable<CreateTypeUdtStatement> {
        ...
        public static CreateTypeUdtStatement FromMutable(ScriptDom.CreateTypeUdtStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.CreateTypeUdtStatement)) { throw new NotImplementedException("Unexpected subtype of CreateTypeUdtStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
