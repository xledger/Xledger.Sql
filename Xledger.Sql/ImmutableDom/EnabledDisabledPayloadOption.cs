...
namespace Xledger.Sql.ImmutableDom {
    public class EnabledDisabledPayloadOption : PayloadOption, IEquatable<EnabledDisabledPayloadOption> {
        ...
        public static EnabledDisabledPayloadOption FromMutable(ScriptDom.EnabledDisabledPayloadOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.EnabledDisabledPayloadOption)) { throw new NotImplementedException("Unexpected subtype of EnabledDisabledPayloadOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
