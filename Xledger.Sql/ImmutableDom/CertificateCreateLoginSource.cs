...
namespace Xledger.Sql.ImmutableDom {
    public class CertificateCreateLoginSource : CreateLoginSource, IEquatable<CertificateCreateLoginSource> {
        ...
        public static CertificateCreateLoginSource FromMutable(ScriptDom.CertificateCreateLoginSource fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.CertificateCreateLoginSource)) { throw new NotImplementedException("Unexpected subtype of CertificateCreateLoginSource not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
