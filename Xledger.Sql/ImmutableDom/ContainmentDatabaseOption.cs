...
namespace Xledger.Sql.ImmutableDom {
    public class ContainmentDatabaseOption : DatabaseOption, IEquatable<ContainmentDatabaseOption> {
        ...
        public new ScriptDom.ContainmentDatabaseOption ToMutableConcrete() {
        ...
        public static ContainmentDatabaseOption FromMutable(ScriptDom.ContainmentDatabaseOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.ContainmentDatabaseOption)) { throw new NotImplementedException("Unexpected subtype of ContainmentDatabaseOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
