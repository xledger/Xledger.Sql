...
namespace Xledger.Sql.ImmutableDom {
    public class TSqlFragmentSnippet : TSqlFragment, IEquatable<TSqlFragmentSnippet> {
        ...
        public static TSqlFragmentSnippet FromMutable(ScriptDom.TSqlFragmentSnippet fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.TSqlFragmentSnippet)) { throw new NotImplementedException("Unexpected subtype of TSqlFragmentSnippet not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
