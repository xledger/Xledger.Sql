...
namespace Xledger.Sql.ImmutableDom {
    public class ColumnEncryptionTypeParameter : ColumnEncryptionDefinitionParameter, IEquatable<ColumnEncryptionTypeParameter> {
        ...
        public override int CompareTo(TSqlFragment that) {
            ...
            compare = Comparer.DefaultInvariant.Compare(this.encryptionType, othr.encryptionType);
        ...
        public static bool operator < (ColumnEncryptionTypeParameter left, ColumnEncryptionTypeParameter right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(ColumnEncryptionTypeParameter left, ColumnEncryptionTypeParameter right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (ColumnEncryptionTypeParameter left, ColumnEncryptionTypeParameter right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(ColumnEncryptionTypeParameter left, ColumnEncryptionTypeParameter right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static ColumnEncryptionTypeParameter FromMutable(ScriptDom.ColumnEncryptionTypeParameter fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.ColumnEncryptionTypeParameter)) { throw new NotImplementedException("Unexpected subtype of ColumnEncryptionTypeParameter not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
