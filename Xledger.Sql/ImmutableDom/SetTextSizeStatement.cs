...
namespace Xledger.Sql.ImmutableDom {
    public class SetTextSizeStatement : TSqlStatement, IEquatable<SetTextSizeStatement> {
        ...
        public static SetTextSizeStatement FromMutable(ScriptDom.SetTextSizeStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.SetTextSizeStatement)) { throw new NotImplementedException("Unexpected subtype of SetTextSizeStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new SetTextSizeStatement(
                textSize: ImmutableDom.ScalarExpression.FromMutable(fragment.TextSize)
            );
        }
