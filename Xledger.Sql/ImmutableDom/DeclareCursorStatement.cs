...
namespace Xledger.Sql.ImmutableDom {
    public class DeclareCursorStatement : TSqlStatement, IEquatable<DeclareCursorStatement> {
        ...
        public static DeclareCursorStatement FromMutable(ScriptDom.DeclareCursorStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.DeclareCursorStatement)) { throw new NotImplementedException("Unexpected subtype of DeclareCursorStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
