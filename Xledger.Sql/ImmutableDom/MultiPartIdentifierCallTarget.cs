...
namespace Xledger.Sql.ImmutableDom {
    public class MultiPartIdentifierCallTarget : CallTarget, IEquatable<MultiPartIdentifierCallTarget> {
        ...
        public static MultiPartIdentifierCallTarget FromMutable(ScriptDom.MultiPartIdentifierCallTarget fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.MultiPartIdentifierCallTarget)) { throw new NotImplementedException("Unexpected subtype of MultiPartIdentifierCallTarget not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
