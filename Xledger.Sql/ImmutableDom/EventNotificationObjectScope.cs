...
namespace Xledger.Sql.ImmutableDom {
    public class EventNotificationObjectScope : TSqlFragment, IEquatable<EventNotificationObjectScope> {
        ...
        public static EventNotificationObjectScope FromMutable(ScriptDom.EventNotificationObjectScope fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.EventNotificationObjectScope)) { throw new NotImplementedException("Unexpected subtype of EventNotificationObjectScope not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
