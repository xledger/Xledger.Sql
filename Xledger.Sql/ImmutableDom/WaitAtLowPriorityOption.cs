...
namespace Xledger.Sql.ImmutableDom {
    public class WaitAtLowPriorityOption : IndexOption, IEquatable<WaitAtLowPriorityOption> {
        ...
        public static WaitAtLowPriorityOption FromMutable(ScriptDom.WaitAtLowPriorityOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.WaitAtLowPriorityOption)) { throw new NotImplementedException("Unexpected subtype of WaitAtLowPriorityOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
