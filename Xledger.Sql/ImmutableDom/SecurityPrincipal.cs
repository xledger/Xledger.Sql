...
namespace Xledger.Sql.ImmutableDom {
    public class SecurityPrincipal : TSqlFragment, IEquatable<SecurityPrincipal> {
        ...
        public static SecurityPrincipal FromMutable(ScriptDom.SecurityPrincipal fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.SecurityPrincipal)) { throw new NotImplementedException("Unexpected subtype of SecurityPrincipal not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
