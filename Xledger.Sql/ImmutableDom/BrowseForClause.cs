...
namespace Xledger.Sql.ImmutableDom {
    public class BrowseForClause : ForClause, IEquatable<BrowseForClause> {
        ...
        public static bool operator < (BrowseForClause left, BrowseForClause right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(BrowseForClause left, BrowseForClause right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (BrowseForClause left, BrowseForClause right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(BrowseForClause left, BrowseForClause right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static BrowseForClause FromMutable(ScriptDom.BrowseForClause fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.BrowseForClause)) { throw new NotImplementedException("Unexpected subtype of BrowseForClause not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
