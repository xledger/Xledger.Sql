...
namespace Xledger.Sql.ImmutableDom {
    public class AlterServerConfigurationSoftNumaOption : TSqlFragment, IEquatable<AlterServerConfigurationSoftNumaOption> {
        ...
        public static AlterServerConfigurationSoftNumaOption FromMutable(ScriptDom.AlterServerConfigurationSoftNumaOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.AlterServerConfigurationSoftNumaOption)) { throw new NotImplementedException("Unexpected subtype of AlterServerConfigurationSoftNumaOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
