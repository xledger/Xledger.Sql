...
namespace Xledger.Sql.ImmutableDom {
    public class AlgorithmKeyOption : KeyOption, IEquatable<AlgorithmKeyOption> {
        ...
        public static AlgorithmKeyOption FromMutable(ScriptDom.AlgorithmKeyOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.AlgorithmKeyOption)) { throw new NotImplementedException("Unexpected subtype of AlgorithmKeyOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
