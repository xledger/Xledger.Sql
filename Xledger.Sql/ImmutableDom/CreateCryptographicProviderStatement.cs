...
namespace Xledger.Sql.ImmutableDom {
    public class CreateCryptographicProviderStatement : TSqlStatement, IEquatable<CreateCryptographicProviderStatement> {
        ...
        public static CreateCryptographicProviderStatement FromMutable(ScriptDom.CreateCryptographicProviderStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.CreateCryptographicProviderStatement)) { throw new NotImplementedException("Unexpected subtype of CreateCryptographicProviderStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
