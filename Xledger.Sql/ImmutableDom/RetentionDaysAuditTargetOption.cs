...
namespace Xledger.Sql.ImmutableDom {
    public class RetentionDaysAuditTargetOption : AuditTargetOption, IEquatable<RetentionDaysAuditTargetOption> {
        ...
        public static RetentionDaysAuditTargetOption FromMutable(ScriptDom.RetentionDaysAuditTargetOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.RetentionDaysAuditTargetOption)) { throw new NotImplementedException("Unexpected subtype of RetentionDaysAuditTargetOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new RetentionDaysAuditTargetOption(
                days: ImmutableDom.Literal.FromMutable(fragment.Days),
