...
namespace Xledger.Sql.ImmutableDom {
    public class SourceDeclaration : ScalarExpression, IEquatable<SourceDeclaration> {
        ...
        public static SourceDeclaration FromMutable(ScriptDom.SourceDeclaration fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.SourceDeclaration)) { throw new NotImplementedException("Unexpected subtype of SourceDeclaration not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new SourceDeclaration(
                @value: ImmutableDom.EventSessionObjectName.FromMutable(fragment.Value)
            );
        }
