...
namespace Xledger.Sql.ImmutableDom {
    public class FetchType : TSqlFragment, IEquatable<FetchType> {
        ...
        public static FetchType FromMutable(ScriptDom.FetchType fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.FetchType)) { throw new NotImplementedException("Unexpected subtype of FetchType not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new FetchType(
                orientation: fragment.Orientation,
                rowOffset: ImmutableDom.ScalarExpression.FromMutable(fragment.RowOffset)
            );
        }
