...
namespace Xledger.Sql.ImmutableDom {
    public class ClassifierImportanceOption : WorkloadClassifierOption, IEquatable<ClassifierImportanceOption> {
        ...
        public static ClassifierImportanceOption FromMutable(ScriptDom.ClassifierImportanceOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.ClassifierImportanceOption)) { throw new NotImplementedException("Unexpected subtype of ClassifierImportanceOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
