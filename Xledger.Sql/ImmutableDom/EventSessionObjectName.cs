...
namespace Xledger.Sql.ImmutableDom {
    public class EventSessionObjectName : TSqlFragment, IEquatable<EventSessionObjectName> {
        ...
        public static bool operator < (EventSessionObjectName left, EventSessionObjectName right) => Comparer.DefaultInvariant.Compare(left, right) <  0;
        public static bool operator <=(EventSessionObjectName left, EventSessionObjectName right) => Comparer.DefaultInvariant.Compare(left, right) <= 0;
        public static bool operator > (EventSessionObjectName left, EventSessionObjectName right) => Comparer.DefaultInvariant.Compare(left, right) >  0;
        public static bool operator >=(EventSessionObjectName left, EventSessionObjectName right) => Comparer.DefaultInvariant.Compare(left, right) >= 0;
        ...
        public static EventSessionObjectName FromMutable(ScriptDom.EventSessionObjectName fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.EventSessionObjectName)) { throw new NotImplementedException("Unexpected subtype of EventSessionObjectName not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new EventSessionObjectName(
                multiPartIdentifier: ImmutableDom.MultiPartIdentifier.FromMutable(fragment.MultiPartIdentifier)
            );
        }
