...
namespace Xledger.Sql.ImmutableDom {
    public class AdHocDataSource : TSqlFragment, IEquatable<AdHocDataSource> {
        ...
        public static AdHocDataSource FromMutable(ScriptDom.AdHocDataSource fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.AdHocDataSource)) { throw new NotImplementedException("Unexpected subtype of AdHocDataSource not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new AdHocDataSource(
                providerName: ImmutableDom.StringLiteral.FromMutable(fragment.ProviderName),
                initString: ImmutableDom.StringLiteral.FromMutable(fragment.InitString)
            );
        }
