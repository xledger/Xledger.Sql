...
namespace Xledger.Sql.ImmutableDom {
    public class OperatorAuditOption : AuditOption, IEquatable<OperatorAuditOption> {
        ...
        public static OperatorAuditOption FromMutable(ScriptDom.OperatorAuditOption fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.OperatorAuditOption)) { throw new NotImplementedException("Unexpected subtype of OperatorAuditOption not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
