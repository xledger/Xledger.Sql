...
namespace Xledger.Sql.ImmutableDom {
    public class WlmTimeLiteral : TSqlFragment, IEquatable<WlmTimeLiteral> {
        ...
        public static WlmTimeLiteral FromMutable(ScriptDom.WlmTimeLiteral fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.WlmTimeLiteral)) { throw new NotImplementedException("Unexpected subtype of WlmTimeLiteral not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
            return new WlmTimeLiteral(
                timeString: ImmutableDom.StringLiteral.FromMutable(fragment.TimeString)
            );
        }
