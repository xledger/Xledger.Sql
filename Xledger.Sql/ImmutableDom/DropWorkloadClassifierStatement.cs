...
namespace Xledger.Sql.ImmutableDom {
    public class DropWorkloadClassifierStatement : DropUnownedObjectStatement, IEquatable<DropWorkloadClassifierStatement> {
        ...
        public static DropWorkloadClassifierStatement FromMutable(ScriptDom.DropWorkloadClassifierStatement fragment) {
            ...
            if (fragment.GetType() != typeof(ScriptDom.DropWorkloadClassifierStatement)) { throw new NotImplementedException("Unexpected subtype of DropWorkloadClassifierStatement not implemented: " + fragment.GetType().Name + ". Regenerate immutable type library."); }
